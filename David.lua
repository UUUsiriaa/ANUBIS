...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅 𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅 ┉ ┉ ┉ ┉ ┉"
...
FilesPrint = FilesPrint.."\27[35m".."𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅 ┉ ┉ ┉ ┉\n".."\27[m"
...
--     Source David     --
----   RioSudo Gp   ----
function RioSudoGp(msg) 
local Status = DevRio:sismember(David..'Rio:RioSudoGp:'..msg.chat_id_,msg.sender_user_id_) 
if Status or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
local Status = DevRio:sismember(David..'Rio:SecondSudoGp:'..msg.chat_id_,msg.sender_user_id_) 
if Status or RioSudoGp(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
local Status = DevRio:sismember(David..'Rio:SudoBotGp:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SecondSudoGp(msg) or RioSudoGp(msg) or SudoBot(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
----   Owner   ----
function Owner(msg) 
local Status = DevRio:sismember(David..'Rio:Owner:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBotGp(msg) or SecondSudoGp(msg) or RioSudoGp(msg) or RioConstructor(msg) or SudoBot(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBotGp(msg) or SecondSudoGp(msg) or RioSudoGp(msg) or SudoBot(msg) or Owner(msg) or RioConstructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBotGp(msg) or SecondSudoGp(msg) or RioSudoGp(msg) or SudoBot(msg) or Owner(msg) or RioConstructor(msg) or BasicConstructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBotGp(msg) or SecondSudoGp(msg) or RioSudoGp(msg) or SudoBot(msg) or Owner(msg) or RioConstructor(msg) or BasicConstructor(msg) or Constructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBotGp(msg) or SecondSudoGp(msg) or RioSudoGp(msg) or SudoBot(msg) or Owner(msg) or RioConstructor(msg) or RioConstructor(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBotGp(msg) or SecondSudoGp(msg) or RioSudoGp(msg) or SudoBot(msg) or Owner(msg) or RioConstructor(msg) or RioConstructor(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Admin(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBotGp(msg) or SecondSudo(msg) or RioSudoGp(msg) or SudoBot(msg) or RioConstructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBotGp(msg) or SecondSudo(msg) or RioSudoGp(msg) or SudoBot(msg) or Cleaner(msg) or RioConstructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
local Status = DevRio:sismember(David..'Rio:CleanerMusic:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBotGp(msg) or SecondSudo(msg) or RioSudoGp(msg) or SudoBot(msg) or Cleaner(msg) or RioConstructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
send(chat,msg.id_," 𖢅⤈ هذا الملف ليس تابع لسورس انوبيس")
return false 
end      
...
send(chat,msg.id_,"𖢅⤈ عذرا الملف ليس بصيغة ↫ Lua يرجى رفع الملف الصحيح")
end      
send(chat,msg.id_,"𖢅⤈ تم رفع الملف الان ارسل تحديث ليتم تحديث الملف")
end
--     Source David     --
function AddFile(msg,chat,ID_FILE,File_Name)
if File_Name:match('.json') then
if File_Name:lower():match('(%d+)') ~= David:lower() then 
send(chat,msg.id_,"𖢅⤈ عذرا هذا الملف ليس تابع لهذا البوت")   
return false 
end
send(chat,msg.id_,"𖢅⤈ جاري رفع الملف ... .")
local File = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..TokenBot..'/'..File.result.file_path, ''..File_Name) 
else
...
var = true 
elseif DevRio:sismember(David..'Rio:RioSudoGp:', user_id) then
var = true 
elseif DevRio:sismember(David..'Rio:SecondSudoGp:', user_id) then
var = true 
elseif DevRio:sismember(David..'Rio:SudoBotGp:', user_id) then
var = true 
elseif DevRio:sismember(David..'Rio:RioConstructor:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(David..'Rio:Owner:'..chat_id, user_id) then
var = true
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ عذرا عزيزي ↫ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
if status == "Reply" then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ العضو ↫ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
if status == "ReplyBy" then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ بواسطة ↫ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ الحساب محذوف قم بالتاكد واعد المحاوله", 1, 'md')
end
end,nil)   
end
--     Source David     --
...
if GetInfo.ok == true then
if GetInfo.result.status == "creator" then
send(msg.chat_id_,msg.id_,'𖢅⤈ مالك المجموعه')   
return false  end 
if GetInfo.result.status == "member" then
send(msg.chat_id_,msg.id_,'𖢅⤈ مجرد عضو هنا')   
return false  end
if GetInfo.result.status == 'left' then
send(msg.chat_id_,msg.id_,'𖢅⤈ الشخص غير موجود هنا')   
return false  end
...
send(msg.chat_id_,msg.id_,'𖢅⤈ صلاحيات '..GetCustomTitle(user_id,msg.chat_id_)..' هي ↫ ⤈\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ حذف الرسائل ↫ '..DEL..'\n𖢅⤈ دعوة المستخدمين ↫ '..INV..'\n𖢅⤈ حظر المستخدمين ↫ '..BAN..'\n𖢅⤈ تثبيت الرسائل ↫ '..PIN..'\n𖢅⤈ تغيير المعلومات ↫ '..EDT..'\n𖢅⤈ اضافة مشرفين ↫ '..VIP..'\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅')
end
end
end
--     Source David     --
...
Text = "*𖢅⤈ عذرا لاتستطيع استخدام البوت !\n𖢅⤈ عليك الاشتراك في القناة اولا :*"
keyboard = {} 
...
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ لا استطيع طرد ↫ "..IdRank(data.sender_user_id_, data.chat_id_)) 
return false
end
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=data.chat_id_,user_id_=data.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,da) 
if (da and da.code_ and da.code_ == 400 and da.message_ == "CHAT_ADMIN_REQUIRED") then 
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
return false  
end
if (da and da.code_ and da.code_ == 3) then 
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ البوت ليس ادمن يرجى ترقيتي !") 
return false  
end
if da and da.code_ and da.code_ == 400 and da.message_ == "USER_ADMIN_INVALID" then 
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ لا استطيع طرد مشرفين المجموعه") 
return false  
end
if da and da.ID and da.ID == "Ok" then
ChatKick(data.chat_id_, data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ تم طردك من المجموعه") 
return false
end
end,nil)  
end
...
DevRio:del(David..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(David..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ تم الغاء امر اطردني") 
end
--     Source David     --
...
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ تم تنزيلك من ↫ ⤈\n~ ( "..constructor..Managers..admins..vipmem..cleaner..donky.." ) ~ \n") 
else 
if IdRank(data.sender_user_id_, data.chat_id_) == 'العضو' then
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ ليس لديك رتبه في البوت") 
else 
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ لا استطيع تنزيل ↫ "..IdRank(data.sender_user_id_, data.chat_id_)) 
end
end
end
--     Source David     --
...
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ تم الغاء امر تغير المطور الاساسي") 
...
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ المطور الجديد ↫ ["..dp.first_name_.."](tg://user?id="..dp.id_..")\n𖢅⤈ تم تغير المطور الاساسي بنجاح") 
end,nil)
tdcli_function ({ID = "GetUser",user_id_ = data.sender_user_id_},function(arg,dp) 
SendText(NewDev,"𖢅⤈ بواسطة ↫ ["..dp.first_name_.."](tg://user?id="..dp.id_..")\n𖢅⤈ لقد اصبحت انت مطور هذا البوت",0,'md')
end,nil)
local Create = function(data, file, uglify)  
file = io.open(file, "w+")   
local serialized   
...
DevRio:del(David..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(David..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ تم الغاء امر نزلني") 
end
...
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ *صاحب الحظ* ↫ ["..UserName.."]\n𖢅⤈ *مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevRio:del(David..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(David.."Rio:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevRio:del(David.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ تم الغاء اللعبه لاعادة اللعب ارسل الالعاب") 
end
if DataText == '/ListRolet' then
local List = DevRio:smembers(David..'Rio:ListRolet'..data.chat_id_) 
local Text = '𖢅⤈ قائمة الاعبين ↫ ⤈\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n' 
local Textt = '𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ تم اكتمال العدد الكلي هل انت مستعد ؟'
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('http://ccccxcc.ml/David/YtAnTak.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('http://ccccxcc.ml/David/YtAnTak.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('http://ccccxcc.ml/David/YtAnTak.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('http://ccccxcc.ml/David/YtAnTak.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
if DataText and DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)')
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ الكلمه ↫ "..Rio.." تم حذفها") 
...
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Rio) 
DevRio:del(David..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ عذرا صلاحية الامر منتهيه !") 
end
end
if DataText and DataText:match('/DelRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/DelRedod:'..tonumber(data.sender_user_id_)..'(.*)')
if DevRio:get(David..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..Rio) 
DevRio:del(David..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevRio:del(David..'Rio:Text:GpTexts'..Rio..data.chat_id_)
...
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ السؤال ↫ "..Rio.." تم حذفه") 
DevRio:del(David..'Rio:Text:KtTexts'..Rio..data.chat_id_)
DevRio:srem(David..'Rio:Sudo:Kt'..data.chat_id_,Rio)
end
...
local List = DevRio:smembers(David..'Rio:Text:KtTexts'..Rio..data.chat_id_)
if DevRio:get(David..'Rio:Add:Kt'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ تم انهاء وحفظ ↫ "..#List.." من الاسئله للامر ↫ "..Rio) 
DevRio:del(David..'Rio:Add:Kt'..data.sender_user_id_..data.chat_id_)
else
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ عذرا صلاحية الامر منتهيه !") 
end
end
...
if DevRio:get(David..'Rio:Add:Kt'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ تم الغاء عملية حفظ الاسئله للامر ↫ "..Rio) 
DevRio:del(David..'Rio:Add:Kt'..data.sender_user_id_..data.chat_id_)
DevRio:del(David..'Rio:Text:KtTexts'..Rio..data.chat_id_)
DevRio:del(David..'Rio:Add:KtTexts'..data.sender_user_id_..data.chat_id_)
DevRio:srem(David..'Rio:Sudo:Kt'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ عذرا صلاحية الامر منتهيه !") 
end
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Song:"..data.sender_user_id_}},{{text="• Ch Anubis • •",url="t.me/SOURCEANUBIS"}}} 
...
local Text ='*𖢅⤈ تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/mp3:"..data.sender_user_id_}},{{text="• Ch Anubis • •",url="t.me/SOURCEANUBIS"}}} 
...
local Text ='*𖢅⤈ تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/memz:"..data.sender_user_id_}},{{text="• Ch Anubis • •",url="t.me/SOURCEANUBIS"}}} 
...
local Text ='*𖢅⤈ تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/gif:"..data.sender_user_id_}},{{text="• Ch Anubis • •",url="t.me/SOURCEANUBIS"}}} 
...
local Text ='*𖢅⤈ تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/photo:"..data.sender_user_id_}},{{text="• Ch Anubis • •",url="t.me/SOURCEANUBIS"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/anime:"..data.sender_user_id_}},{{text="• Ch Anubis • •",url="t.me/SOURCEANUBIS"}}} 
...
DevRio:sadd(David..'Rio:VipMem:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم رفعه في قائمة المميزين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:Cleaner:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم رفعه في قائمة المنظفين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:Admins:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم رفعه في قائمة الادمنيه')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:Managers:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم رفعه في قائمة المدراء')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:Constructor:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم رفعه في قائمة المنشئين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:BasicConstructor:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم رفعه في قائمة المنشئين الاساسيين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:RioConstructor:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم رفعه في قائمة المالكين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:SudoBot:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم رفعه في قائمة المطورين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:SecondSudo:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم رفعه في قائمة المطورين الثانويين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:RioSudo:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم رفعه في قائمة المطورين الاساسيين')
end,nil)
end
--     Source David     --
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:VipMem:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم تنزيله في قائمة المميزين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:Cleaner:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم تنزيله في قائمة المنظفين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:Admins:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم تنزيله في قائمة الادمنيه')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:Managers:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم تنزيله في قائمة المدراء')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:Constructor:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم تنزيله في قائمة المنشئين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:BasicConstructor:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم تنزيله في قائمة المنشئين الاساسيين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:RioConstructor:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم تنزيله في قائمة المالكين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:SudoBot:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم تنزيله في قائمة المطورين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:SecondSudo:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم تنزيله في قائمة المطورين الثانويين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:RioSudo:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم تنزيله في قائمة المطورين الاساسيين')
end,nil)
end
--     Source David     --
...
EditMsg(Chat_Id2, Msg_Id2, '𖢅⤈ لا تستطيع حظر ↫ '..IdRank(dp.id_, data.chat_id_), 1, 'md')
else
ChatKick(data.chat_id_, dp.id_)
DevRio:sadd(David..'Rio:Ban:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم حظره')
end
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:Ban:'..data.chat_id_,dp.id_)
...
if dp.id_ then
if RankChecking(dp.id_, data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, '𖢅⤈ لا تستطيع كتم ↫ '..IdRank(dp.id_, data.chat_id_), 1, 'md')
else
if DevRio:sismember(David..'Rio:Muted:'..data.chat_id_, dp.id_) then
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(David..'Rio:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم كتمه')
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم الغاء كتمه')
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:BanAll:', dp.id_)
DevRio:srem(David..'Rio:MuteAll:', dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم الغاء العام')
end,nil)
end
...
if dp.id_ then
if RankChecking(dp.id_, data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, '𖢅⤈ لا تستطيع تقيد ↫ '..IdRank(dp.id_, data.chat_id_), 1, 'md')
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..data.chat_id_.."&user_id="..dp.id_)
DevRio:sadd(David..'Rio:Tkeed:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم تقيده من المجموعه')
end
end
end,nil)
end
...
DevRio:srem(David..'Rio:Tkeed:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')\n𖢅⤈ تم الغاء تقيده')
end,nil)
end
--     Source David     --
...
local Text = '𖢅⤈ قم باستعمال الازرار لتنزيل العضو ↫ ⤈\n𖢅⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'SOURCEANUBIS')..')'
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=data.sender_user_id_..":RemSudoBot:"..Rio}},{{text="• تنزيل مطور ثانوي •",callback_data=data.sender_user_id_..":RemSecondSudo:"..Rio},{text="• تنزيل مطور اساسي •",callback_data=data.sender_user_id_..":RemRioSudo:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif RioSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=data.sender_user_id_..":RemSudoBot:"..Rio}},{{text="• تنزيل مطور ثانوي •",callback_data=data.sender_user_id_..":RemSecondSudo:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=data.sender_user_id_..":RemSudoBot:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif Owner(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text = '• David TeAM •',url="t.me/SOURCEANUBIS"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
local Del = DevRio:get(David..'Rio:Del')
local Text = [[
𖢅⤈ اهلا بك في قائمة اوامر الرتب ↫ ⤈ 
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
*𖢅⤈ يمكنك مسح رتب المجموعه من خلال الازرار اسفل*
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ [𝘾𝙃 𝘼𝙉𝙐𝘽𝙄𝙎 𓏶 ](https://t.me/SOURCEANUBIS)
]] 
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelRioSudo:"..data.sender_user_id_},{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..data.sender_user_id_}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..data.sender_user_id_},{text="• مسح المالكين •",callback_data="/DelOwner:"..data.sender_user_id_}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..data.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..data.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..data.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif RioSudo(data) then
...
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..data.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..data.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..data.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
DevRio:del(David..'Rio:Owner:'..data.chat_id_)
Text = "*𖢅⤈ تم حذف المالكين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
DevRio:del(David..'Rio:UsersMsgs'..data.chat_id_..':'..data.sender_user_id_)
Text = "*𖢅⤈ تم حذف المنشئين الاساسيين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
DevRio:del(David..'Rio:Constructor:'..data.chat_id_)
Text = "*𖢅⤈ تم حذف المنشئين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
DevRio:del(David..'Rio:Managers:'..data.chat_id_)
Text = "*𖢅⤈ تم حذف المدراء*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
DevRio:del(David..'Rio:Admins:'..data.chat_id_)
Text = "*𖢅⤈ تم حذف الادمنيه*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
DevRio:del(David..'Rio:VipMem:'..data.chat_id_)
Text = "*𖢅⤈ تم حذف المميزين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
DevRio:del(David..'Rio:Cleaner:'..data.chat_id_)
Text = "*𖢅⤈ تم حذف المنظفين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
DevRio:del(David..'Rio:Muted:'..data.chat_id_)
Text = "*𖢅⤈ تم حذف المكتومين*"
keyboard = {} 
...
local List = DevRio:smembers(David..'Rio:Tkeed:'..data.chat_id_)
for k,v in pairs(List) do   
...
DevRio:srem(David..'Rio:Tkeed:'..data.chat_id_, v)
end
Text = "*𖢅⤈ تم حذف المقيدين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David..'Rio:Ban:'..data.chat_id_)
Text = "*𖢅⤈ تم حذف المحظورين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
Text = "*𖢅⤈ تم حذف قائمه العام*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
if DataText and DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)') and not DevRio:get(David..'Rio:Lock:GpRd'..data.chat_id_) then
local Rio = DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)')
local redod = DevRio:smembers(David..'Rio:Manager:GpRed'..data.chat_id_)
if #redod == 0 then
Text = "*𖢅⤈ لا توجد ردود مضافه*"
else
for k,v in pairs(redod) do
DevRio:del(David..'Rio:Gif:GpRed'..v..data.chat_id_)
DevRio:del(David..'Rio:Voice:GpRed'..v..data.chat_id_)
DevRio:del(David..'Rio:Audio:GpRed'..v..data.chat_id_)
DevRio:del(David..'Rio:Photo:GpRed'..v..data.chat_id_)
DevRio:del(David..'Rio:Stecker:GpRed'..v..data.chat_id_)
DevRio:del(David..'Rio:Video:GpRed'..v..data.chat_id_)
DevRio:del(David..'Rio:File:GpRed'..v..data.chat_id_)
DevRio:del(David..'Rio:Text:GpRed'..v..data.chat_id_)
DevRio:del(David..'Rio:Manager:GpRed'..data.chat_id_)
end
Text = "*𖢅⤈ تم حذف ردود المدير*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}}}
...
if DataText and DataText:match('/DelGpRedAll:'..tonumber(data.sender_user_id_)..'(.*)') and not DevRio:get(David..'Rio:Lock:GpRd'..data.chat_id_) then
...
if not Bot(data) and DevRio:get(David..'Rio:Lock:Rd'..data.chat_id_) then 
Dev_Rio(data.chat_id_, data.id_, 1,'𖢅⤈ لاتستطيع اضافه رد وذالك بسبب تعطيله', 1, 'md')
return false
end
if not Manager(data) then
Dev_Rio(data.chat_id_, data.id_, 1, '𖢅⤈ للمدير واعلى فقط ', 1, 'md')
else
DevRio:set(David..'Rio:Add:GpRed'..data.sender_user_id_..data.chat_id_,'SetGpRed')
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ حسنا ارسل الكلمه الان") 
return false
end end
if text and text:match("^(.*)$") then
local SetGpRed = DevRio:get(David..'Rio:Add:GpRed'..data.sender_user_id_..data.chat_id_)
if SetGpRed == 'SetGpRed' then
if text == "الغاء" then 
Dev_Rio(data.chat_id_, data.id_, 1, "𖢅⤈ تم الغاء الامر" ,  1, "md")
DevRio:del(David..'Rio:Add:GpRed'..data.sender_user_id_..data.chat_id_)
return false
end
Text = "𖢅⤈ ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n𖢅⤈ يمكنك اضافة الى النص ↫ ⤈\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ للخروج ارسل ↫ ( الغاء )\n ✓"
...
DevRio:set(David..'DelManagerRep'..data.chat_id_,text)
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeRed:"..data.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelRed:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
--     Source David     --
...
if not Bot(data) and DevRio:get(David..'Rio:Lock:Rd'..data.chat_id_) then 
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ لا تستطيع اضافه رد وذالك بسبب تعطيله") 
return false
end
if not SecondSudo(data) then
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ للمطور الثانوي واعلى فقط") 
else
DevRio:set(David.."Rio:Add:AllRed"..data.sender_user_id_,'SetAllRed')
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ حسنا ارسل الكلمه الان") 
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevRio:get(David.."Rio:Add:AllRed"..data.sender_user_id_)
if SetAllRed == 'SetAllRed' then
if text == "الغاء" then 
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ تم الغاء الامر") 
DevRio:del(David..'Rio:Add:AllRed'..data.sender_user_id_)
return false
end
Text = "𖢅⤈ ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n𖢅⤈ يمكنك اضافة الى النص ↫ ⤈\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n `#username` ↬ معرف المستخدم\n `#datas` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ للخروج ارسل ↫ ( الغاء )\n ✓"
DevRio:set(David.."Rio:Add:AllRed"..data.sender_user_id_,'SaveAllRed')
DevRio:set(David.."Rio:Add:AllText"..data.sender_user_id_, text)
DevRio:sadd(David.."Rio:Sudo:AllRed",text)
DevRio:set(David.."DelSudoRep",text)
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeAllRed:"..data.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelAllRed:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
--     Source David     --
...
local List = DevRio:smembers(David.."List:Cmd:Group:New"..data.chat_id_)
for k,v in pairs(List) do
DevRio:del(David.."Set:Cmd:Group:New1"..data.chat_id_..":"..v)
DevRio:del(David.."List:Cmd:Group:New"..data.chat_id_)
end
Text = "𖢅⤈ تم حذف الاوامر المضافه في المجموعه"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/CmdList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":ا","ايدي")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"ا")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":م","رفع مميز")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"م")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":اد","رفع ادمن")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"اد")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":مد","رفع مدير")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"مد")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":من","رفع منشئ")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"من")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":اس","رفع منشئ اساسي")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"اس")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":مط","رفع مطور")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"مط")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":ثانوي","رفع مطور ثانوي")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"ثانوي")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":تك","تنزيل الكل")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"تك")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"تعط")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"تفع")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":ر","الرابط")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"ر")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":رر","ردود المدير")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"رر")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":،،","مسح المكتومين")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"،،")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":رد","اضف رد")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"رد")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":غ","غنيلي")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"غ")
DevRio:set(David.."Set:Cmd:Group:New1"..data.chat_id_..":#","مسح قائمه العام")
DevRio:sadd(David.."List:Cmd:Group:New"..data.chat_id_,"#")
Text = "𖢅⤈ تم ترتيب الاوامر بالشكل التالي ~\n𖢅⤈  ايدي - ا .\n𖢅⤈  رفع مميز - م .\n𖢅⤈ رفع ادمن - اد .\n𖢅⤈  رفع مدير - مد . \n𖢅⤈  رفع منشى - من . \n𖢅⤈  رفع منشئ الاساسي - اس  .\n𖢅⤈  رفع مطور - مط .\n𖢅⤈ رفع مطور ثانوي - ثانوي .\n𖢅⤈  تنزيل الكل - تك .\n𖢅⤈  تعطيل الايدي بالصوره - تعط .\n𖢅⤈  تفعيل الايدي بالصوره - تفع .\n𖢅⤈  الرابط - ر .\n𖢅⤈  ردود المدير - رر .\n𖢅⤈  مسح المكتومين - ،، .\n𖢅⤈  اضف رد - رد .\n𖢅⤈  مسح سحكاتي - سح .\n𖢅⤈  مسح رسائلي - رس .\n𖢅⤈  غنيلي - غ .\n𖢅⤈ مسح قائمه العام"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/CmdList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
...
DevRio:del(David.."Rio:Add:AllText"..data.sender_user_id_)
DevRio:del(David.."Rio:Add:AllRed"..data.sender_user_id_)
DevRio:del(David.."DelSudoRep")
Text = "𖢅⤈ تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
local DelManagerRep = DevRio:get(David..'DelManagerRep'..data.chat_id_)
DevRio:srem(David..'Rio:Manager:GpRed'..data.chat_id_,DelManagerRep)
DevRio:del(David..'Rio:Add:GpText'..data.sender_user_id_..data.chat_id_)
DevRio:del(David..'Rio:Add:GpRed'..data.sender_user_id_..data.chat_id_)
DevRio:del(David..'DelManagerRep'..data.chat_id_)
Text = "𖢅⤈ تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Cmd = DevRio:get(David..'Rio:Cmd')
local Text = [[
*𖢅⤈ من خلال الازرار يمكنك التحكم بأوامر المجموعه*
]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• ترتيب الاوامر •",callback_data="/SetCmd:"..data.sender_user_id_},{text="• مسح الاوامر المضافه •",callback_data="/DelCmd:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Msg = DevRio:get(David..'Rio:Msg')
local Text = [[
*𖢅⤈ من خلال الازرار يمكنك مسح رسائلك وسحكاتك*
]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح رسائلي •",callback_data="/DelMsg:"..data.sender_user_id_},{text="• مسح سحكاتي •",callback_data="/DelEdit:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
...
DevRio:del(David..'Rio:EditMsg'..data.chat_id_..':'..data.sender_user_id_)
Text = "*𖢅⤈ تم حذف جميع تعديلاتك بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/DelHome:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source David     --
...
DevRio:del(David..'Rio:UsersMsgs'..data.chat_id_..':'..data.sender_user_id_)
Text = "*𖢅⤈ تم حذف جميع رسائلك بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/DelHome:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David.."Rio:FilterAnimation"..data.chat_id_)
Text = "*𖢅⤈ تم حذف جميع المتحركات الممنوعه بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/FilterList:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David.."Rio:FilterSteckr"..data.chat_id_)
Text = "*𖢅⤈ تم حذف جميع الملصقات الممنوعه بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/FilterList:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David.."Rio:FilterPhoto"..data.chat_id_)
Text = "*𖢅⤈ تم حذف جميع الصور الممنوعه بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/FilterList:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David..'Rio:Filters:'..data.chat_id_)
Text = "*𖢅⤈ تم حذف جميع الكلمات الممنوعه بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/FilterList:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David.."Rio:FilterPhoto"..data.chat_id_)
DevRio:del(David.."Rio:FilterSteckr"..data.chat_id_)
Text = "*𖢅⤈ تم حذف جميع قوائم المنع بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/FilterList:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local LockBotList = DevRio:get(David..'Rio:LockBotList')
local Text = [[
𖢅⤈ اهلا بك في قائمة قفل البوتات  ↫ ⤈ 
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
*𖢅⤈ بالطرد*
*𖢅⤈ بالكتم*
*𖢅⤈ بالتقيد*
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• قفل البوتات بالطرد •",callback_data="/lockBotKick:"..data.sender_user_id_},{text="• قفل البوتات بالتقيد •",callback_data="/lockBotKed:"..data.sender_user_id_}},{{text="• قفل البوتات بالكتم •",callback_data="/lockBotDel:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source David     --
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local LockSpamList = DevRio:get(David..'Rio:LockSpamList')
local Text = [[
𖢅⤈ اهلا بك في قائمة قفل التكرار  ↫ ⤈ 
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
*𖢅⤈ بالطرد*
*𖢅⤈ بالكتم*
*𖢅⤈ بالتقيد*
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• قفل التكرار بالطرد •",callback_data="/lockSpamKick:"..data.sender_user_id_},{text="• قفل التكرار بالتقيد •",callback_data="/lockSpamKed:"..data.sender_user_id_}},{{text="• قفل التكرار بالحذف •",callback_data="/lockSpamDel:"..data.sender_user_id_},{text="• قفل التكرار بالكتم •",callback_data="/lockSpamMute:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source David     --
if DataText == '/lockjoin:'..data.sender_user_id_ then
if not DevRio:get(David..'Rio:Lock:Join'..data.chat_id_) then
DevRio:set(David..'Rio:Lock:Join'..data.chat_id_,true)
Text = "*𖢅⤈ تم قفل الدخول بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
end
if DataText == '/unlockjoin:'..data.sender_user_id_ then
if DevRio:get(David..'Rio:Lock:Join'..data.chat_id_) then
DevRio:del(David..'Rio:Lock:Join'..data.chat_id_)
Text = "*𖢅⤈ تم فتح الدخول بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
if DataText == '/lockText:'..data.sender_user_id_ then
if not DevRio:get(David..'Rio:Lock:Text'..data.chat_id_) then
DevRio:set(David..'Rio:Lock:Text'..data.chat_id_,true)
Text = "*𖢅⤈ تم قفل الدردشه بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
...
if DevRio:get(David..'Rio:Lock:Text'..data.chat_id_) then
DevRio:del(David..'Rio:Lock:Text'..data.chat_id_)
Text = "*𖢅⤈ تم فتح الدردشه بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
if DataText == '/lockTagServr:'..data.sender_user_id_ then
if not DevRio:get(David..'Rio:Lock:TagServr'..data.chat_id_) then
DevRio:set(David..'Rio:Lock:TagServr'..data.chat_id_,true)
Text = "*𖢅⤈ تم قفل الاشعارات بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
...
if DevRio:get(David..'Rio:Lock:TagServr'..data.chat_id_) then
DevRio:del(David..'Rio:Lock:TagServr'..data.chat_id_) 
Text = "*𖢅⤈ تم فتح الاشعارات بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
if DataText == '/lockEditMsgs:'..data.sender_user_id_ then
if not DevRio:get(David..'Rio:Lock:EditMsgs'..data.chat_id_) then
DevRio:set(David..'Rio:Lock:EditMsgs'..data.chat_id_,true)
Text = "*𖢅⤈ تم قفل التعديل بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
...
if DevRio:get(David..'Rio:Lock:EditMsgs'..data.chat_id_) then
DevRio:del(David..'Rio:Lock:EditMsgs'..data.chat_id_)
Text = "*𖢅⤈ تم فتح التعديل بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
if DataText == '/lockStickers:'..data.sender_user_id_ then
if not DevRio:get(David..'Rio:Lock:Stickers'..data.chat_id_) then
DevRio:set(David..'Rio:Lock:Stickers'..data.chat_id_,true)
Text = "*𖢅⤈ تم قفل الملصقات بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
...
if DevRio:get(David..'Rio:Lock:Stickers'..data.chat_id_) then
DevRio:del(David..'Rio:Lock:Stickers'..data.chat_id_)
Text = "*𖢅⤈ تم فتح الملصقات بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
if DataText == '/lockGifs:'..data.sender_user_id_ then
if not DevRio:get(David..'Rio:Lock:Gifs'..data.chat_id_) then
DevRio:set(David..'Rio:Lock:Gifs'..data.chat_id_,true)
Text = "*𖢅⤈ تم قفل المتحركه بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
...
if DevRio:get(David..'Rio:Lock:Gifs'..data.chat_id_) then
DevRio:del(David..'Rio:Lock:Gifs'..data.chat_id_)
Text = "*𖢅⤈ تم فتح المتحركه بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
if DataText == '/lockPhoto:'..data.sender_user_id_ then
if not DevRio:get(David..'Rio:Lock:Photo'..data.chat_id_) then
DevRio:set(David..'Rio:Lock:Photo'..data.chat_id_,true) 
Text = "*𖢅⤈ تم قفل الصور بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
...
if DevRio:get(David..'Rio:Lock:Photo'..data.chat_id_) then
DevRio:del(David..'Rio:Lock:Photo'..data.chat_id_)
Text = "*𖢅⤈ تم فتح الصور بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
if DataText == '/lockVideos:'..data.sender_user_id_ then
if not DevRio:get(David..'Rio:Lock:Videos'..data.chat_id_) then
DevRio:set(David..'Rio:Lock:Videos'..data.chat_id_,true)
Text = "*𖢅⤈ تم قفل الفيديو بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
...
if DevRio:get(David..'Rio:Lock:Videos'..data.chat_id_) then
DevRio:del(David..'Rio:Lock:Videos'..data.chat_id_)
Text = "*𖢅⤈ تم فتح الفيديو بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
if DataText == '/lockForwards:'..data.sender_user_id_ then
if not DevRio:get(David..'Rio:Lock:Forwards'..data.chat_id_) then
DevRio:set(David..'Rio:Lock:Forwards'..data.chat_id_,true)
Text = "*𖢅⤈ تم قفل التوجيه بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
...
if DevRio:get(David..'Rio:Lock:Forwards'..data.chat_id_) then
DevRio:del(David..'Rio:Lock:Forwards'..data.chat_id_) 
Text = "*𖢅⤈ تم فتح التوجيه بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
if DataText == '/lockBotKick:'..data.sender_user_id_ then
DevRio:set(David.."Rio:Lock:Bots"..data.chat_id_,"kick")  
Text = "*𖢅⤈ تم قفل البوتات بالطرد بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockBotList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText == '/lockBotKed:'..data.sender_user_id_ then
DevRio:set(David.."Rio:Lock:Bots"..data.chat_id_,"ked")   
Text = "*𖢅⤈ تم قفل البوتات بالتقييد بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockBotList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText == '/lockBotDel:'..data.sender_user_id_ then
DevRio:set(David.."Rio:Lock:Bots"..data.chat_id_,"del")  
Text = "*𖢅⤈ تم قفل البوتات بالكتم بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockBotList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
if DataText == '/unlockBot:'..data.sender_user_id_ then
DevRio:del(David.."Rio:Lock:Bots"..data.chat_id_) 
Text = "*𖢅⤈ تم فتح البوتات بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText == '/lockSpamKick:'..data.sender_user_id_ then
DevRio:hset(David.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","kick")  
Text = "*𖢅⤈ تم قفل التكرار بالطرد بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockSpamList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText == '/lockSpamKed:'..data.sender_user_id_ then
DevRio:hset(David.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","keed")  
Text = "*𖢅⤈ تم قفل التكرار بالتقيد بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockSpamList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText == '/lockSpamDel:'..data.sender_user_id_ then
DevRio:hset(David.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","del")  
Text = "*𖢅⤈ تم قفل التكرار بالحذف بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockSpamList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
if DataText == '/lockSpamMute:'..data.sender_user_id_ then
DevRio:hset(David.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","mute")  
Text = "*𖢅⤈ تم قفل التكرار بالكتم بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockSpamList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
if DataText == '/unlockSpam:'..data.sender_user_id_ then
DevRio:hdel(David.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User")  
Text = "*𖢅⤈ تم فتح التكرار بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Source = DevRio:get(David..'Rio:Source')
local Text = [[
*𖢅⤈ اليك ازرار تحديث السورس والملفات*
]] 
keyboard = {} 
...
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
Text = "*𖢅⤈ تم تحديث السورس*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/SourceList:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Media = DevRio:get(David..'Rio:Media')
local Text = [[
*𖢅⤈ اليك ازرار مسح الميديا*
]] 
keyboard = {} 
...
local List = DevRio:smembers(David.."Rio:cleaner"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
if Del ~= 0 then
Dev_Rio(data.chat_id_, data.id_, 1, "𖢅⤈ تم حذف "..Del.." من الميديا", 1, 'md') 
DevRio:del(David.."Rio:cleaner"..data.chat_id_)
else
Text = "*𖢅⤈ لا توجد ميديا هنا*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/MediaHome:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
local List = DevRio:smembers(David.."Rio:cleanermusic"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
if Del ~= 0 then
Dev_Rio(data.chat_id_, data.id_, 1, "𖢅⤈ تم حذف "..Del.." من الاغاني", 1, 'md') 
DevRio:del(David.."Rio:cleanermusic"..data.chat_id_)
else
Text = "*𖢅⤈ لا توجد اغاني هنا*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/MediaHome:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end end
...
Text = "*𖢅⤈ تم تنظيف الرسائل المعدله*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/MediaHome:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
EditMsg(Chat_Id2, Msg_Id2,  "𖢅⤈ المغادره معطله من قبل المطور الاساسي", 'md')
return false  
end
EditMsg(Chat_Id2, Msg_Id2,  "*𖢅⤈ تم مغادرة المجموعه \n𖢅⤈ تم حذف جميع بياناتها*", 'md')
ChatLeave(data.chat_id_, David) 
DevRio:srem(David.."Rio:Groups",data.chat_id_)
end           
if DataText and DataText:match('/NoLeaveBot:(.*)') then
local Rio = DataText:match('/NoLeaveBot:(.*)')
if tonumber(Rio) == tonumber(data.sender_user_id_) then
EditMsg(Chat_Id2, Msg_Id2, "*𖢅⤈ تم الغاء امر طرد البوت*")
else
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..data.chat_id_)) or DevRio:get(David.."Private:Group:Link"..data.chat_id_) 
if linkgpp.ok == true then 
local Text = '𖢅⤈ 𝖫𝗂𝗇𝗄 𝖦𝗋𝗈𝗎𝗉 ↬ ⤈\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n['..ta.title_..']('..linkgpp.result..')'
keyboard = {}  
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}}}
...
if not DevRio:get(David..'Rio:Lock:GpLinks'..data.chat_id_) then 
if DevRio:get(David.."Rio:Groups:Links"..data.chat_id_) then
send(data.chat_id_, data.id_, "𖢅⤈ Group Link ↬ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n"..DevRio:get(David.."Rio:Groups:Links"..data.chat_id_), 1, "html")
else 
send(data.chat_id_, data.id_, 1, '𖢅⤈ لايوجد رابط ارسل ↫ ضع رابط او ارسل ↫ انشاء رابط للانشاء', 1, 'md')
end
else
end
end
...
DevRio:set(David..'Rio:Lock:Id:Photo'..data.chat_id_,true)
Text = "*𖢅⤈ تم تعطيل الايدي بالصوره*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David..'Rio:Lock:Id:Photo'..data.chat_id_)
Text = "*𖢅⤈ تم تفعيل الايدي بالصوره*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:set(David..'Rio:Lock:Id'..data.chat_id_,true)
Text = "*𖢅⤈ تم تعطيل الايدي*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David..'Rio:Lock:Id'..data.chat_id_)
Text = "*𖢅⤈ تم تفعيل الايدي*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:set(David.."Rio:Lock:GpLinks"..data.chat_id_,"ok")
Text = "*𖢅⤈ تم تعطيل الرابط*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David.."Rio:Lock:GpLinks"..data.chat_id_)
Text = "*𖢅⤈ تم تفعيل الرابط*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:set(David.."Rio:Lock:GpLinksinline"..data.chat_id_,"ok")
Text = "*𖢅⤈ تم تعطيل الرابط انلاين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David.."Rio:Lock:GpLinksinline"..data.chat_id_)
Text = "*𖢅⤈ تم تفعيل الرابط انلاين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David.."Rio:Lock:Welcome"..data.chat_id_)
Text = "*𖢅⤈ تم تعطيل الترحيب*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:set(David.."Rio:Lock:Welcome"..data.chat_id_,true)
Text = "*𖢅⤈ تم تفعيل الترحيب*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:set(David..'Rio:Lock:AllRed'..data.chat_id_,true)
Text = "*𖢅⤈ تم تعطيل ردود المطور*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David..'Rio:Lock:AllRed'..data.chat_id_)
Text = "*𖢅⤈ تم تفعيل ردود المطور*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:set(David..'Rio:Lock:GpRed'..data.chat_id_,true)
Text = "*𖢅⤈ تم تعطيل ردود المدير*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David..'Rio:Lock:GpRed'..data.chat_id_)
...
DevRio:set(David.."Rio:Del:Me"..data.chat_id_, true)
Text = "*𖢅⤈ تم تعطيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David.."Rio:Del:Me"..data.chat_id_)
Text = "*𖢅⤈ تم تفعيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:set(David.."Rio:Kick:Me"..data.chat_id_, true)
Text = "*𖢅⤈ تم تعطيل اطردني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David.."Rio:Kick:Me"..data.chat_id_)
Text = "*𖢅⤈ تم تفعيل اطردني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:set(David.."Rio:Lock:KickBan"..data.chat_id_,"true")
Text = "*𖢅⤈ تم تعطيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David.."Rio:Lock:KickBan"..data.chat_id_)
Text = "*𖢅⤈ تم تفعيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:set(David.."Rio:Lock:ProSet"..data.chat_id_,"true")
Text = "*𖢅⤈ تم تعطيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David.."Rio:Lock:ProSet"..data.chat_id_)
Text = "*𖢅⤈ تم تفعيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:set(David..'Rio:Lock:Games'..data.chat_id_,true)  
Text = "*𖢅⤈ تم تعطيل الالعاب*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(David..'Rio:Lock:Games'..data.chat_id_) 
Text = "*𖢅⤈ تم تفعيل الالعاب*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
EditMsg(Chat_Id2, Msg_Id2, "𖢅⤈ تم اخفاء كليشة الاوامر") 
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ عذرا الامر ليس لك .")..'&show_alert=true')
end
end
...
𖢅⤈ حذف رد من متعدد
𖢅⤈ الردود المتعدده
𖢅⤈ حذف الردود المتعدده
𖢅⤈ حذف قوائم المنع
𖢅⤈ منع ↫ بالرد على ( ملصق • صوره • متحركه )
𖢅⤈ حذف قائمه منع + ↫ ⤈
( الصور • المتحركات • الملصقات )
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ تنزيل الكل
𖢅⤈ رفع ادمن • تنزيل ادمن
𖢅⤈ الادمنيه • حذف الادمنيه
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ تثبيت
𖢅⤈ الغاء التثبيت
𖢅⤈ اعاده التثبيت
𖢅⤈ الغاء تثبيت الكل
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ تغير رد + اسم الرتبه + النص ↫ ⤈
𖢅⤈ المطور • منشئ الاساسي
𖢅⤈ المنشئ • المدير • الادمن
𖢅⤈ المميز • المنظف • العضو
𖢅⤈ حذف ردود الرتب
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ تغيير الايدي ↫ لتغيير الكليشه
𖢅⤈ تعيين الايدي ↫ لتعيين الكليشه
𖢅⤈ حذف الايدي ↫ لحذف الكليشه
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ تفعيل • تعطيل + الامر ↫ ⤈
𖢅⤈ اطردني • الايدي بالصوره • الابراج
𖢅⤈ معاني الاسماء • اوامر النسب • انطق
𖢅⤈ الايدي • تحويل الصيغ • اوامر التحشيش
𖢅⤈ ردود المدير • ردود المطور • التحقق
𖢅⤈ ضافني • حساب العمر • الزخرفه
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ [𝘾𝙃 𝘼𝙉𝙐𝘽𝙄𝙎 𓏶 ](https://t.me/SOURCEANUBIS)
]]
keyboard = {} 
...
𖢅⤈ ترتيب الاوامر
𖢅⤈ اضف • حذف ↫ امر
𖢅⤈ حذف الاوامر المضافه
𖢅⤈ الاوامر المضافه
𖢅⤈ اضف نقاط ↫ بالرد • بالايدي
𖢅⤈ اضف رسائل ↫ بالرد • بالايدي
𖢅⤈ رفع منظف • تنزيل منظف
𖢅⤈ المنظفين • حذف المنظفين
𖢅⤈ رفع مدير • تنزيل مدير
𖢅⤈ المدراء • حذف المدراء
𖢅⤈ تفعيل • تعطيل + الامر ↫ ⤈
𖢅⤈ نزلني • امسح
𖢅⤈ الحظر • الكتم
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ اوامر المنشئين الاساسيين ↫ ⤈
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ وضع لقب + اللقب
𖢅⤈ تفعيل • تعطيل ↫ الرفع
𖢅⤈ رفع منشئ • تنزيل منشئ
𖢅⤈ المنشئين • حذف المنشئين
𖢅⤈ رفع • تنزيل ↫ مشرف
𖢅⤈ رفع بكل الصلاحيات
𖢅⤈ حذف القوائم
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
...
𖢅⤈ حذف المنشئين الاساسيين 
𖢅⤈ المنشئين الاساسيين 
𖢅⤈ حذف جميع الرتب
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ [𝘾𝙃 𝘼𝙉𝙐𝘽𝙄𝙎 𓏶 ](https://t.me/SOURCEANUBIS)
]]
...
𖢅⤈ اسم البوت + تعطيل
𖢅⤈ كشف + -ايدي المجموعه
𖢅⤈ رفع مالك • تنزيل مالك
𖢅⤈ المالكين • حذف المالكين
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ رفع • تنزيل ↫ مدير عام
𖢅⤈ حذف • المدراء العامين 
𖢅⤈ رفع • تنزيل ↫ ادمن عام
𖢅⤈ حذف • الادمنيه العامين 
𖢅⤈ رفع • تنزيل ↫ مميز عام
𖢅⤈ حذف • المميزين عام 
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ اوامر المطور الاساسي ↫ ⤈
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ تحديث
𖢅⤈ السيرفر
𖢅⤈ روابط الجروبات
...
𖢅⤈ تنظيف المشتركين
𖢅⤈ حذف جميع الملفات
𖢅⤈ تعيين الايدي العام
𖢅⤈ تغير المطور الاساسي
𖢅⤈ حذف معلومات الترحيب
𖢅⤈ تغير معلومات الترحيب
𖢅⤈ غادر + -ايدي المجموعه
𖢅⤈ تعيين عدد الاعضاء + العدد
𖢅⤈ حظر عام • الغاء العام
𖢅⤈ كتم عام • الغاء العام
𖢅⤈ قائمه العام • حذف قائمه العام
𖢅⤈ وضع • حذف ↫ اسم البوت
𖢅⤈ اضف • حذف ↫ رد عام
𖢅⤈ ردود المطور • حذف ردود المطور
𖢅⤈ تعيين • حذف • جلب ↫ رد الخاص
𖢅⤈ جلب نسخه الجروبات
𖢅⤈ رفع النسخه + بالرد على الملف
𖢅⤈ تعيين • حذف ↫ قناة الاشتراك
𖢅⤈ جلب كليشه الاشتراك
𖢅⤈ تغيير • حذف ↫ كليشه الاشتراك
𖢅⤈ رفع • تنزيل ↫ مطور
𖢅⤈ المطورين • حذف المطورين
𖢅⤈ رفع • تنزيل ↫ مطور ثانوي
𖢅⤈ الثانويين • حذف الثانويين
𖢅⤈ تعيين • حذف ↫ كليشة الايدي
𖢅⤈ اذاعه للكل بالتوجيه ↫ بالرد
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ تفعيل ملف + اسم الملف
𖢅⤈ تعطيل ملف + اسم الملف
𖢅⤈ تفعيل • تعطيل + الامر ↫ ⤈
𖢅⤈ الاذاعه • الاشتراك الاجباري
𖢅⤈ ترحيب البوت • المغادره
𖢅⤈ البوت الخدمي • التواصل
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
𖢅⤈ [𝘾𝙃 𝘼𝙉𝙐𝘽𝙄𝙎 𓏶 ](https://t.me/SOURCEANUBIS)
]]
keyboard = {} 
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• اوامر الادمنيه •",callback_data="/HelpList2:"..data.sender_user_id_},{text="• اوامر الحمايه •",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="• اوامر المنشئين •",callback_data="/HelpList4:"..data.sender_user_id_},{text="• اوامر المدراء •",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• اوامر الادمنيه •",callback_data="/HelpList2:"..data.sender_user_id_},{text="• اوامر الحمايه •",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="• اوامر المدراء •",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• اوامر الادمنيه •",callback_data="/HelpList2:"..data.sender_user_id_},{text="• اوامر الحمايه •",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
else
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
end
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ عذرا الامر ليس لك .")..'&show_alert=true')
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حذف الامر من المجموعه", 1, 'html')  
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لايوجد امر بهذا الاسم", 1, 'html')
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل الامر الجديد", 1, 'html')
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حفظ الامر", 1, 'html')
...
if #List == 0 then
t = "𖢅⤈ لاتوجد اوامر مضافه في المجموعه"
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الاوامر المضافه •",callback_data="/DelCmd:"..msg.sender_user_id_},{text="• ترتيب الاوامر •",callback_data="/SetCmd:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حذف الاوامر المضافه في المجموعه", 1, 'html')
end
if text == "حذف الاوامر المضافه" and ChCheck(msg) or text == "حذف الاوامر" and ChCheck(msg) or text == "مسح الاوامر المضافه" and ChCheck(msg) then
local List = DevRio:smembers(David.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل الامر القديم", 1, 'html')
return false
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل الامر الذي قمت باضافته يدويا", 1, 'html')
return false
end
end
--     Source David     --
...
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لاتوجد صلاحيات مضافه", 1, 'html')
return false
end
t = "𖢅⤈ قائمة الصلاحيات المضافه ↫ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n"
for k,v in pairs(List) do
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حذف الصلاحيات المضافه", 1, 'html')
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n𖢅⤈ ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevRio:del(David.."Comd:New:rt:Rio:"..ComdNew..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حذف الصلاحيه", 1, 'html')
end
if DevRio:get(David.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^↫ الغاء ᥀$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم الغاء الامر", 1, 'html')
DevRio:del(David.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
if not Constructor(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تستطيع اضافة صلاحية ( عضو • مميز  • ادمن )\n𖢅⤈ ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
if text == "ادمن" then
if not Manager(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تستطيع اضافة صلاحية ( عضو • مميز )\n𖢅⤈ ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
if text == "مميز" then
if not Admin(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تستطيع اضافة صلاحية ( عضو )\n𖢅⤈ ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم اضافة الصلاحيه", 1, 'html')
DevRio:del(David.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCEANUBIS')..')'..' ❩\n𖢅⤈ تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
...
local mrrio = DevRio:get(David.."Comd:New:rt:Rio:"..DEV_RIO..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCEANUBIS')..')'..' ❩\n𖢅⤈ تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
...
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'SOURCEANUBIS')..')'..' ❩\n𖢅⤈ تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ *المعرف غير صحيح*", 1, 'md')
end
end
...
local mrrio = DevRio:get(David.."Comd:New:rt:Rio:"..text1[2]..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'SOURCEANUBIS')..')'..' ❩\n𖢅⤈ تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
local Sudo_Welcome = '𖢅⤈ مرحبا عزيزي المطور \n𖢅⤈ انت المطور الاساسي هنا \n𖢅⤈ اليك ازرار سورس انوبيس \n𖢅⤈ تستطيع التحكم بكل الاوامر فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '𖢅⤈ اهلا بك مجددا عزيزي المطور \n𖢅⤈ اليك الازرار الخاصه بتعديل وتغيير كلايش سورس انوبيس فقط اضغط على الامر الذي تريد تنفيذه'
...
if text == '↫ السورس ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '𖢅⤈ اهلا بك مجددا عزيزي المطور \n𖢅⤈ اليك الازرار الخاصه بتحديث  سورس انوبيس فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '𖢅⤈ اهلا بك مجددا عزيزي المطور \n𖢅⤈ اليك الازرار الخاصه ب أحصائيات  سورس انوبيس فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '𖢅⤈ اهلا بك مجددا عزيزي المطور \n𖢅⤈ اليك الازرار الخاصه ب المطورين لسورس انوبيس فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '𖢅⤈ اهلا بك مجددا عزيزي المطور \n𖢅⤈ اليك الازرار الخاصه ب التفعيل والتعطيل لسورس انوبيس فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '𖢅⤈ اهلا بك مجددا عزيزي المطور \n𖢅⤈ اليك الازرار الخاصه بالاذاعه لسورس انوبيس فقط اضغط على الامر الذي تريد تنفيذه'
...
if text == '↫ العام ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '𖢅⤈ اهلا بك مجددا عزيزي المطور \n𖢅⤈ اليك الازرار الخاصه بالعام لسورس انوبيس فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '𖢅⤈ اهلا بك مجددا عزيزي المطور \n𖢅⤈ اليك الازرار الخاصه بردود الخاص لسورس انوبيس فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '𖢅⤈ اهلا بك مجددا عزيزي المطور \n𖢅⤈ اليك الازرار الخاصه بالاشتراك الاجباري لسورس انوبيس فقط اضغط على الامر الذي تريد تنفيذه'
...
local Sudo_Welcome = '𖢅⤈ اهلا بك مجددا عزيزي \n𖢅⤈ اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس انوبيس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ اوامر التسليه ᥀','↫ الاوامر الخدميه  ᥀'},{'↫ اوامر النسب ᥀','↫ البوتات ᥀'},{'↫ العاب ᥀'},{'↫  السورس ᥀','↫  المطور ᥀'},{'↫ رجوع ᥀'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
if text == '↫ اوامر التسليه ᥀' then 
local Sudo_Welcome = '𖢅⤈ اهلا بك مجددا عزيزي \n𖢅⤈ اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس انوبيس فقط اضغط على الامر الذي تريد تنفيذه'
...
local Sudo_Welcome = '𖢅⤈ اهلا بك مجددا عزيزي \n𖢅⤈ اليك الازرار الخاصه بأوامر البوتات الخاصه بسورس انوبيس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ بوت الحذف ᥀','↫ بوت الهمسه ᥀'},{'↫ بوت اليوتيوب ᥀','↫ بوت الكت ᥀'},{'↫ بوت الزخرفه ᥀'},{'↫  رجوع  ᥀'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
if text == '↫ اوامر النسب ᥀' then 
local Sudo_Welcome = '𖢅⤈ اهلا بك مجددا عزيزي \n𖢅⤈ اليك الازرار الخاصه بأوامر النسب الخاصه بسورس انوبيس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ نسبه الكره ᥀','↫ نسبه الحب ᥀'},{'↫ نسبه الرجوله ᥀','↫ نسبه الانوثه ᥀'},{'↫ نسبه الغباء ᥀','↫ نسبه الجمال ᥀'},{'↫ نسبه الخيانه ᥀'},{'↫  رجوع  ᥀'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
if text == '↫ العاب ᥀' then 
local Sudo_Welcome = '𖢅⤈ اهلا بك مجددا عزيزي \n𖢅⤈ اليك الازرار الخاصه بألعاب سورس انوبيس فقط اضغط على اللعبه الذي تريد لعبها'
...
Start_Source = "𖢅⤈ مرحبا انا بوت اسمي "..NameBot.."\n𖢅⤈ اختصاصي حماية المجموعات\n𖢅⤈ من التفليش والسبام والخخ .. . ،\n𖢅⤈ تفعيلي سهل ومجانا فقط قم برفعي ادمن في مجموعتك وارسل امر ↫ تفعيل\n𖢅⤈ سيتم رفع الادمنيه والمنشئ تلقائيا\n𖢅⤈ ارسل امر /free او /play للتمتع باوامر الاعضاء"
end 
...
Dev_Rio(msg.sender_user_id_, msg.id_, 1, '𖢅⤈ تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "SOURCEANUBIS")..')', 1, 'md') 
tdcli_function({ID="ForwardMessages",chat_id_=DevId,from_chat_id_= msg.sender_user_id_,message_ids_={[0]=msg.id_},disable_notification_=1,from_background_=1},function(arg,data) 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
if data and data.messages_ and data.messages_[0] ~= false and data.ID ~= "Error" then
if data and data.messages_ and data.messages_[0].content_.sticker_ then
SendText(DevId,'𖢅⤈ تم ارسال الملصق من ↫ ⤈\n['..string.sub(dp.first_name_,0, 40)..'](tg://user?id='..dp.id_..')',0,'md') 
return false
...
local Text = '𖢅⤈ العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n𖢅⤈ تم حظره من التواصل'
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ العضو قام بحظر البوت لا تستطيع ارسال الرسائل له', 1, 'md')
return false  
end 
if text then
Dev_Rio(id_user, 0, 1, text, 1, "md")  
Text = '𖢅⤈ تم ارسال الرساله الى ↫ ⤈'
elseif msg.content_.ID == 'MessageSticker' then    
sendSticker(id_user, msg.id_, 0, 1,nil, msg.content_.sticker_.sticker_.persistent_id_)   
Text = '𖢅⤈ تم ارسال الملصق الى ↫ ⤈'
elseif msg.content_.ID == 'MessagePhoto' then    
sendPhoto(id_user, msg.id_, 0, 1,nil, msg.content_.photo_.sizes_[0].photo_.persistent_id_,(msg.content_.caption_ or ''))    
Text = '𖢅⤈ تم ارسال الصوره الى ↫ ⤈'
elseif msg.content_.ID == 'MessageAnimation' then    
sendDocument(id_user, msg.id_, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_)    
Text = '𖢅⤈ تم ارسال المتحركه الى ↫ ⤈'
elseif msg.content_.ID == 'MessageVoice' then    
sendVoice(id_user, msg.id_, 0, 1,nil, msg.content_.voice_.voice_.persistent_id_)    
Text = '𖢅⤈ تم ارسال البصمه الى ↫ ⤈'
end     
...
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء حفظ كليشة الستارت', 1, 'md')
DevRio:del(David..'Rio:Start:Bots'..msg.sender_user_id_) 
return false
end
DevRio:set(David.."Rio:Start:Bot",text)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم حفظ كليشة الستارت', 1, 'md')
DevRio:del(David..'Rio:Start:Bots'..msg.sender_user_id_) 
return false
end
if SecondSudo(msg) then
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ ارسل لي كليشة الستارت الان', 1, 'md')
return false
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم حذف كليشة الستارت بنجاح', 1, 'md')
end
...
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تعطيل التواصل بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(David..'Rio:Texting:Pv',true) 
end
if Sudo(msg) then
if text == 'تفعيل النسخه التلقائيه' or text == 'تفعيل جلب نسخه الجروبات' or text == 'تفعيل عمل نسخه للمجموعات' or text == '↫ تفعيل النسخه التلقائيه ᥀' then   
Dev_Rio(msg.chat_id_,msg.id_, 1, "𖢅⤈ تم تفعيل جلب نسخة الجروبات التلقائيه\n𖢅⤈ سيتم ارسال نسخه تلقائيه للجروبات كل يوم الى خاص المطور الاساسي", 1, 'md')
DevRio:del(David.."Rio:Lock:AutoFile")
end
if text == 'تعطيل النسخه التلقائيه' or text == 'تعطيل جلب نسخه الجروبات' or text == 'تعطيل عمل نسخه للمجموعات' or text == '↫ تعطيل النسخه التلقائيه ᥀' then  
Dev_Rio(msg.chat_id_,msg.id_, 1, "𖢅⤈ تم تعطيل جلب نسخة الجروبات التلقائيه", 1, 'md')
DevRio:set(David.."Rio:Lock:AutoFile",true) 
end
end
end
--     Source David     --
if text == "الابراج" or text == "↫ الابراج ᥀" then  Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈  من خلال البوت يمكنك معرفه توقعات برجك \n𖢅⤈  فقط قم بارسال امر برج + اسم البرج \n𖢅⤈  مثال : برج الاسد ،\n𖢅⤈  لمعرفه برجك قم بالرجوع الى قسم حساب العمر ', 1, 'md') end
if text == "حساب العمر" or text == "↫ حساب العمر ᥀" then  Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈  من خلال البوت يمكنك حساب عمرك \n𖢅⤈  فقط قم بارسال امر احسب + مواليدك الى البوت \n𖢅⤈  بالتنسيق التالي مثال : احسب 2000/7/24', 1, 'md') end
if text == "الحمايه" or text == "↫ الحمايه ᥀" then  Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈  اضف البوت في المجموعه ثم قم برفعه مشرف وارسل تفعيل \n𖢅⤈  وتمتع بخدمات غير موجوده في باقي البوتات ', 1, 'md') end
if text == "الزخرفه" or text == "↫ الزخرفه ᥀" then  Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ قم بأرسال أمر زخرفه وثم ارسال الاسم الذي تريد زخرفته بألانكليزي أو العربي', 1, 'md') end
if text == "معاني الاسماء" or text == "↫ معاني الاسماء ᥀" then  Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈  من خلال البوت يمكنك معرفه معنى اسمك \n𖢅⤈  فقط قم بارسال امر معنى اسم + الاسم \n𖢅⤈  مثال : معنى اسم ريو', 1, 'md') end
if text == "عدد المسح" or text == "تعين عدد المسح" or text == "تعيين عدد المسح" then  Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈  فقط قم بارسال امر عدد المسح + عدد المسح \n𖢅⤈  مثال : عدد المسح 100', 1, 'md') end
if text == "انطق" then  Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈  فقط قم بارسال امر انطق + الكلمه\n𖢅⤈ سيقوم البوت بنطق الكلمه \n𖢅⤈  مثال : انطق هلو', 1, 'md') end
if text == "يوتيوب" and ChCheck(msg) or text == "اليوتيوب" and ChCheck(msg) or text == "↫ بوت اليوتيوب ᥀" and ChCheck(msg) or text == "بوت اليوتيوب" and ChCheck(msg) or text == "اريد بوت يوتيوب" and ChCheck(msg) or text == "شمرلي بوت يوتيوب" and ChCheck(msg) or text == "يوت" and ChCheck(msg) then local inline = {{{text="• اضغط هنا •",url="https://t.me/t_stbot"}}} SendInline(msg.chat_id_,'*𖢅⤈ اضغط للحصول على بوت اليوتيوب*',nil,inline) return false end
if text == "اهمس" and ChCheck(msg) or text == "↫ بوت الهمسه ᥀" and ChCheck(msg) or text == "بوت الهمسه" and ChCheck(msg) or text == "همسه" and ChCheck(msg) or text == "اريد بوت الهمسه" and ChCheck(msg) or text == "دزلي بوت الهمسه" and ChCheck(msg) or text == "دزولي بوت الهمسه" and ChCheck(msg) then  Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ @HMSEBOT\n𖢅⤈ @nnbbot\n𖢅⤈ @ocBot\n𖢅⤈ @hebot ', 1, 'md') end
if text == "رابط حذف" and ChCheck(msg) or text == "رابط الحذف" and ChCheck(msg) or text == "اريد رابط الحذف" and ChCheck(msg) or text == "شمرلي رابط الحذف" and ChCheck(msg) or text == "اريد رابط حذف" and ChCheck(msg) then local inline = {{{text="• اضغط هنا •",url="https://t.me/DYFBOT"}}} SendInline(msg.chat_id_,'*𖢅⤈ اضغط للحصول على رابط الحذف*',nil,inline) return false end
if text == "↫ بوت الحذف ᥀" and ChCheck(msg) or text == "بوت الحذف" and ChCheck(msg) or text == "اريد بوت الحذف" and ChCheck(msg) or text == "اريد بوت حذف" and ChCheck(msg) or text == "بوت حذف" and ChCheck(msg) or text == "بوت حذف حسابات" and ChCheck(msg) or text == "راح احذف" and ChCheck(msg) then local inline = {{{text="• اضغط هنا •",url="https://t.me/DYFBOT"}}} SendInline(msg.chat_id_,'*𖢅⤈ اضغط للحصول على بوت الحذف*',nil,inline) return false end
if text == "↫ بوت الكت ᥀" and ChCheck(msg) or text == "بوت الكت" and ChCheck(msg) or text == "بوت كت" and ChCheck(msg) then local inline = {{{text="• اضغط هنا •",url="https://t.me/E9OBot"}}} SendInline(msg.chat_id_,'*𖢅⤈ اضغط للحصول على بوت الكت*',nil,inline) return false end
if text == "↫ بوت الزخرفه ᥀" and ChCheck(msg) or text == "بوت الزخرفه" and ChCheck(msg) or text == "بوت زخرفه" and ChCheck(msg) then local inline = {{{text="• اضغط هنا •",url="https://t.me/W5555Bot"}}} SendInline(msg.chat_id_,'*𖢅⤈ اضغط للحصول على بوت الزخرفه*',nil,inline) return false end
if text == "ايديي" and ChCheck(msg) or text == "↫ ايديي ᥀" and ChCheck(msg) then Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ ايديك ↫ ❨ `'..msg.sender_user_id_..'` ❩', 1, 'md') end
-- Source David --
...
Text = "*𖢅⤈ Dev Name ↬ * ["..result.first_name_.."](T.me/"..result.username_..")\n*𖢅⤈ Dev User ↬* [@"..result.username_.."]\n*𖢅⤈ Dev id ↬* ["..result.id_.."](T.me/"..result.username_..")"
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or SOURCEANUBIS}}}
...
text = '𖢅⤈ اسمك ↫ firstname lastname'
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ للمطور الاساسي فقط', 1, 'md')
else 
tdcli_function({ID ="GetChat",chat_id_=Text[2]},function(arg,dp) 
if dp.id_ then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ المجموعه ↫ ["..dp.title_.."]\n𖢅⤈ تمت المغادره منها بنجاح", 1, "md")
Dev_Rio(Text[2], 0, 1, "𖢅⤈ بامر المطور تم مغادرة هذه المجموعه ", 1, "md")  
ChatLeave(dp.id_, David)
DevRio:srem(David.."Rio:Groups", dp.id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لم تتم اضافتي بها لاقوم بمغادرتها", 1, "md")
end 
end,nil)
end 
end
...
SendText(DevId,"𖢅⤈ تم طرد البوت من المجموعه ↫ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ بواسطة ↫ "..Name.."\n𖢅⤈ اسم المجموعه ↫ ["..NameChat.."]\n𖢅⤈ ايدي المجموعه ↫ ⤈ \n❨ `"..msg.chat_id_.."` ❩\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ الوقت ↫ "..os.date("%I:%M%p").."\n𖢅⤈ التاريخ ↫ "..os.date("%Y/%m/%d").."",0,'md')
end
end,nil)
end,nil)
end
...
if ChatType == 'pv' then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لاتستطيع تفعيلي هنا يرجى اضافتي في مجموعه اولا', 1, 'md')
return false
end
if ChatType ~= 'sp' then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ المجموعه عاديه وليست خارقه لا تستطيع تفعيلي يرجى ان تضع سجل رسائل المجموعه ضاهر وليس مخفي ومن بعدها يمكنك رفعي ادمن ثم تفعيلي', 1, 'md')
return false
end
if msg.can_be_deleted_ == false then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ البوت ليس ادمن يرجى ترقيتي !', 1, 'md')
return false  
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevRio:get(David..'Rio:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ عدد اعضاء المجموعه اقل من ↫ *'..(DevRio:get(David..'Rio:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","𖢅⤈ تم تفعيل المجموعه "..dp.title_)  
...
SendText(DevId,"𖢅⤈ تم تفعيل مجموعه جديده ↫ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ بواسطة ↫ "..Name.."\n𖢅⤈ موقعه في المجموعه ↫ "..status.."\n𖢅⤈ اسم المجموعه ↫ ["..NameChat.."]\n𖢅⤈ عدد اعضاء المجموعه ↫ ❨ *"..NumMem.."* ❩\n𖢅⤈ ايدي المجموعه ↫ ⤈ \n❨ `"..msg.chat_id_.."` ❩\n𖢅⤈ رابط المجموعه ↫ ⤈\n❨ ["..LinkGroup.."] ❩\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ الوقت ↫ "..os.date("%I:%M%p").."\n𖢅⤈ التاريخ ↫ "..os.date("%Y/%m/%d").."",0,'md')
end
end end
end,nil)
end,nil)
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا تستطيع تفعيل هذه المجموعه بسبب تعطيل البوت الخدمي من قبل المطور الاساسي', 1, 'md') 
end 
end 
--     Source David     --
...
local Text = '𖢅⤈ اهلا عزيزي ↫ ['..string.sub(dp.first_name_,0, 40)..'](tg://user?id='..dp.id_..')\n𖢅⤈ يجب علينا التأكد أنك لست روبوت\n𖢅⤈ تم تقيدك اضغط الزر بالاسفل لفكه'
keyboard = {} 
...
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","𖢅⤈ الصوره التي ارسلتها تم منعها من المجموعه")  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return false   
end
end
...
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","𖢅⤈ المتحركه التي ارسلتها تم منعها من المجموعه")  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
end
end
...
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","𖢅⤈ الملصق الذي ارسلته تم منعه من المجموعه")  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return false   
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(David..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ 𖢅⤈ تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevRio:del(David..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if #List == 4 then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حفظ ↫ 5 من الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevRio:del(David..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
return false
end
local Rio = "𖢅⤈ تم حفظ الرد رقم ↫ "..(#List+1).."\n𖢅⤈ قم بارسال الرد رقم ↫ "..(#List+2)
keyboard = {} 
...
--     Source David     --
if text and text:match("^(.*)$") then
local SaveKt = DevRio:get(David..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SaveKt == 'SaveKt' then
local GetKtTexts = DevRio:get(David..'Rio:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevRio:smembers(David..'Rio:Text:KtTexts'..GetKtTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ 𖢅⤈ تم الغاء عملية حفظ اسئلة الكت  ↫ "..GetKtTexts ,  1, "md")
DevRio:del(David..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(David..'Rio:Text:KtTexts'..GetKtTexts..msg.chat_id_)
DevRio:del(David..'Rio:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(David..'Rio:Sudo:Kt'..msg.chat_id_,GetKtTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevRio:sadd(David..'Rio:Text:KtTexts'..GetKtTexts..msg.chat_id_,Text)
if #List == 100 then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حفظ ↫ 100 من اسئلة الكت ↫ "..GetKtTexts ,  1, "md")
DevRio:del(David..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
return false
end
local Rio = "𖢅⤈ تم حفظ الرد رقم ↫ "..(#List+1).."\n𖢅⤈ قم بارسال السؤال رقم ↫ "..(#List+2)
keyboard = {} 
...
if text and not DevRio:get(David..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_) then
if DevRio:sismember(David..'Rio:Sudo:Kt'..msg.chat_id_,text) then
local DavidTeam =  DevRio:smembers(David..'Rio:Text:KtTexts'..text..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '['..DavidTeam[math.random(#DavidTeam)]..']' , 1, 'md')  
end
end
--     Source David     --
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء حفظ الرد', 1, 'md')
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم حفظ الرد الجديد', 1, 'md') 
DevRio:del(David..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(David..'DelManagerRep'..msg.chat_id_)
return false 
end 
...
Text = '𖢅⤈ العضو ↫ '..GetName..' \n𖢅⤈ قام بالتكرار المحدد تم طرده '
...
Text = '𖢅⤈ العضو ↫ '..GetName..' \n𖢅⤈ قام بالتكرار المحدد تم تقيده '
SendText(msg.chat_id_,Text,0,'md')
return false  
end  
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ عدد مشاهدات المنشور هي ↫ ('..msg.views_..')', 1, 'md')
DevRio:del(David..'Rio:viewget'..msg.sender_user_id_)
end
end
--     Source David     --
...
if DevRio:sismember(David..'Rio:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n𖢅⤈ ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n𖢅⤈ بعد ذلك يرجى ارسال امر ↫ تفعيل\n𖢅⤈ سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevRio:get(David.."Rio:Text:BotWelcome") then RioText = DevRio:get(David.."Rio:Text:BotWelcome") else RioText = "𖢅⤈ مرحبا انا بوت اسمي "..NameBot.."\n𖢅⤈ حالة المجموعه ↫ "..BotText.."\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅" end 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم حفظ الرابط بنجاح', 1, 'md')
DevRio:del(David.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false 
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء الامر', 1, 'md')
...
Dev_Rio(msg.chat_id_, msg.id_,  1, "𖢅⤈ تم اضافة "..numadded..' رساله', 1, 'md')
DevRio:del('DavidTeam:'..David..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
...
Dev_Rio(msg.chat_id_, msg.id_,  1, "𖢅⤈ تم اضافة "..numadded..' نقطه', 1, 'md')
DevRio:del('DavidTeam:'..David..'ids:user'..msg.chat_id_)  
end
end
--     Source David     --
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","𖢅⤈ ممنوع الفشار في المجموعه")  
end end
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","𖢅⤈ ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","𖢅⤈ ممنوع الكفر في المجموعه") 
end end
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","𖢅⤈ ممنوع التكلم بالطائفيه هنا") 
end end
--     Source David     --
if SecondSudo(msg) then
...
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..David..'.json', '𖢅⤈ يحتوي الملف على ↫ ⤈\n مجموعه '..#List..' \n مشترك '..#Users..' ' ,dl_cb, nil)
...
Dev_Rio( msg.chat_id_, msg.id_, 1,"𖢅⤈ يوجد فقط ( 6 ) اختيارات\n𖢅⤈ ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevRio:get(David.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(David.."SET:GAME"..msg.chat_id_)   
Dev_Rio( msg.chat_id_, msg.id_, 1,'𖢅⤈ *المحيبس باليد رقم* ↫ '..NUM..'\n𖢅⤈ *مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevRio:incrby(David..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevRio:del(David.."SET:GAME"..msg.chat_id_)   
Dev_Rio( msg.chat_id_, msg.id_, 1,'𖢅⤈ *المحيبس باليد رقم* ↫ '..GETNUM..'\n𖢅⤈ *للاسف لقد خسرت حاول مره اخرى للعثور على المحيبس*', 1, "md")
end
end
end
...
send(msg.chat_id_, msg.id_, '𖢅⤈ عذرا لا يمكنك وضع معرف حسابات في الاشتراك')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_, '𖢅⤈ عذرا لا يمكنك وضع معرف مجموعه في الاشتراك')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,'𖢅⤈ البوت ادمن في القناة \n𖢅⤈ تم تفعيل الاشتراك الاجباري \n𖢅⤈ ايدي القناة ↫ '..data.id_..'\n𖢅⤈ معرف القناة ↫ [@'..data.type_.channel_.username_..']')
DevRio:set(David..'Rio:ChId',data.id_)
else
send(msg.chat_id_, msg.id_,'𖢅⤈ عذرا البوت ليس ادمن في القناة')
end
return false  
end
end,nil)
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حفظ كليشة المطور", 1, "md")
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم حفظ اسم البوت ', 1, 'html')
DevRio:del(David..'Rio:NameBot'..msg.sender_user_id_)
...
NameBot = (DevRio:get(David..'Rio:NameBot') or 'انوبيس')
local namebot = {'مقولت اسمي 😡 '..NameBot..' ',' مسميش بوت اسمي  '..NameBot..' '} 
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ لم تربح اي نقطه\n𖢅⤈ ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ عدد النقاط التي ربحتها ↫ '..(DevRio:get(David..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevRio:del(David..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم حذف جميع نقاطك', 1, 'md') end
--     Source David     --
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
DavidTeam = '𖢅⤈ اول واحد يدز هذا السمايل يربح ↫ '..name
...
DavidTeam = '𖢅⤈ مبروك لقد ربحت في اللعبه \n𖢅⤈ ارسل ↫ سمايلات للعب مره اخرى'
Dev_Rio(msg.chat_id_, msg.id_, 1,DavidTeam, 1, 'md')
...
DavidTeam = '𖢅⤈ اول واحد يرتبها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,DavidTeam, 1, 'md')
return false
end end
if text == DevRio:get(David..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(David..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(David..'Rio:Games:Ids'..msg.chat_id_) then 
DavidTeam = '𖢅⤈ مبروك لقد ربحت في اللعبه \n𖢅⤈ ارسل ↫ ترتيب للعب مره اخرى'
Dev_Rio(msg.chat_id_, msg.id_, 1,DavidTeam, 1, 'md')
DevRio:incrby(David..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevRio:set(David..'Rio:Games:Ids'..msg.chat_id_,true)
...
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
𖢅⤈ اختر رقم لاستخراج المحيبس
𖢅⤈ الفائز يحصل على (5) نقاط
]]
...
DavidTeam = '𖢅⤈ اول واحد يحلها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,DavidTeam, 1, 'md')
return false
end end
if text == DevRio:get(David..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(David..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(David..'Rio:Games:Ids'..msg.chat_id_) then 
DavidTeam = '𖢅⤈ مبروك لقد ربحت في اللعبه \n𖢅⤈ ارسل ↫ حزوره للعب مره اخرى'
Dev_Rio(msg.chat_id_, msg.id_, 1,DavidTeam, 1, 'md')
DevRio:incrby(David..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevRio:set(David..'Rio:Games:Ids'..msg.chat_id_,true)
...
DavidTeam = '𖢅⤈ اكمل المثال التالي ↫ ['..name..']'
Dev_Rio(msg.chat_id_, msg.id_, 1,DavidTeam, 1, 'md')
return false
end end
...
DavidTeam = '𖢅⤈ اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,DavidTeam, 1, 'md')
return false
end end
...
DevRio:del(David..'Rio:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'النيل','𖢅⤈ ماهو اطول نهر في العالم ؟\n1- النيل\n2- الفرات\n3- نهر الكونغو')
name = string.gsub(name,'14','𖢅⤈ ماعدد عظام الوجه ؟\n1- 15\n2- 13\n3- 14')
name = string.gsub(name,'الفم','𖢅⤈ كراسي بيضاء وجدران ورديه اذا اغلقته اصبح ظلام  فمن اكون ؟\n1- الفم\n2- الاذن\n3- الثلاجه')
name = string.gsub(name,'11','𖢅⤈ كم جزء يحتوي مسلسل وادي الذئاب ؟\n1- 7\n2- 15\n3- 11')
name = string.gsub(name,'30','𖢅⤈ كم جزء يحتوي القران الكريم ؟\n1- 60\n2- 70\n3- 30')
name = string.gsub(name,'بوتين','𖢅⤈ من هوه اغنى رئيس في العالم ؟\n1- ترامب\n2- اوباما\n3- بوتين')
name = string.gsub(name,'ستيف جوبر','𖢅⤈ من هوه مؤسس شركه ابل العالميه  ؟\n1- لاري بايج\n2- بيل جيتس\n3- ستيف جوبر')
name = string.gsub(name,'باريس','ماهي عاصمه فرنسا ؟\n1- باريس\n2- لوين\n3- موسكو')
name = string.gsub(name,'10','𖢅⤈ ماعدد دول العربيه التي توجد في افريقيا ؟\n1- 10\n2- 17\n3- 9')
name = string.gsub(name,'النمل','𖢅⤈ ماهو الحيوان الذي يحمل 50 فوق وزنه ؟\n1- الفيل\n2- النمل\n3- الثور')
name = string.gsub(name,'حرف الواو','𖢅⤈ ماذا يوجد بيني وبينك ؟\n1- الضل\n2- الاخلاق\n3- حرف الواو')
name = string.gsub(name,'الشعر','𖢅⤈ ماهو الشيء النبات ينبت للانسان بلا بذر ؟\n1- الاضافر\n2- الاسنان\n3- الشعر')
name = string.gsub(name,'سحاب','𖢅⤈ ما هو الشّيء الذي يستطيع المشي بدون أرجل والبكاء بدون أعين ؟\n1- سحاب\n2- بئر\n3- نهر')
name = string.gsub(name,'الاسم','𖢅⤈ ما الشيء الذي نمتلكه , لكنّ غيرنا يستعمله أكثر منّا ؟\n1- العمر\n2- ساعه\n3- الاسم')
name = string.gsub(name,'ذهب','𖢅⤈ اصفر اللون سارق عقول اهل الكون وحارمهم لذيذ النوم ؟\n1- نحاس\n2- الماس\n3- ذهب')
name = string.gsub(name,'حرف الام','𖢅⤈ في الليل ثلاثة لكنه في النهار واحده فما هو ؟\n1- حرف الباء\n2- حرف الام\n3- حرف الراء')
name = string.gsub(name,'العزائم','𖢅⤈ على قدر اصل العزم تأتي ؟\n1- العزائم\n2- المكارم\n3- المبائب')
name = string.gsub(name,'انسات','𖢅⤈ ماهي جمع كلمه انسه ؟\n1- سيدات\n2- انسات\n3- قوانص')
name = string.gsub(name,'المنجنيق','𖢅⤈ اله اتسعلمت قديما في الحروب ؟\n1- الصاروخ\n2- المسدس\n3- المنجنيق')
name = string.gsub(name,'اسيا','𖢅⤈ تقع لبنان في قاره ؟\n1- افريقيا\n2- اسيا\n3- امركيا الشماليه')
name = string.gsub(name,'6','𖢅⤈ كم صفرا للمليون ؟\n1- 4\n2- 3\n3- 6')
name = string.gsub(name,'الاسد','𖢅⤈ ماهو الحيوان الذي يلقب بملك الغابه ؟\n1- الفيل\n2- الاسد\n3- النمر')
name = string.gsub(name,'مهر','𖢅⤈ ما اسم صغير الحصان ؟\n1- مهر\n2- جرو\n3- عجل')
name = string.gsub(name,'الدولفين','𖢅⤈ ما الحيوان الذي ينام واحدى عينه مفتوحه ؟\n1- القرش\n2- الدولفين\n3- الثعلب\n')
name = string.gsub(name,'اوروبا','𖢅⤈ ماهي القاره التي تلقب بالقاره العجوز ؟\n1- اوروبا\n2- امريكا الشماليه\n3- افريقيا')
name = string.gsub(name,'الزئبق','𖢅⤈ ما اسم المعدن الموجود فيي الحاله السائله ؟\n1- النحاس\n2- الحديد\n3- الزئبق')
name = string.gsub(name,'لندن','𖢅⤈ ماهي عاصمه انجلترا ؟\n1- لندن\n2- لفرسول\n3- تركيا')
name = string.gsub(name,'الانسان','𖢅⤈ ماهو الشئ الذي برأسه سبع فتحات ؟\n1- الهاتف\n2- التلفاز\n3- الانسان')
name = string.gsub(name,'طوكيو','𖢅⤈ ماهي عاصمه اليابان ؟\n1- بانكول\n2- نيو دلهي\n3- طوكيو')
name = string.gsub(name,'خديجه','𖢅⤈ من هي زوجه الرسول الاكبر منه سنآ ؟\n1- حفضه\n2- زينب\n3- خديجه')
DavidTeam = name..'\n𖢅⤈ ارسل الجواب الصحيح فقط'
Dev_Rio(msg.chat_id_, msg.id_, 1,DavidTeam, 1, 'md')
return false
end end
...
Dev_Rio(msg.chat_id_, msg.id_, 1,"𖢅⤈ عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
...
DevRio:incrby(David..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ *التخمين الصحيح هو* ↫ '..NUM..'\n𖢅⤈ *مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
...
DevRio:del(David..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(David.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ *التخمين الصحيح هو* ↫ '..GETNUM..'\n𖢅⤈ *للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ لقد خمنت الرقم الخطا وتبقى لديك '..SetNum..' ارسل رقم تخمنه مره اخرى للفوز', 1, 'md')
end
end
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n 𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n𖢅⤈ ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevRio:get(David.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "𖢅⤈ لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevRio:set(David.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '𖢅⤈ تم بدء تسجيل اللسته يرجى ارسال المعرفات \n𖢅⤈ الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
...
send(msg.chat_id_,msg.id_,'𖢅⤈ المعرف ↫ ['..text..'] موجود اساسا')
return false
end
tdcli_function ({ID = "SearchPublicChat",username_ = text},function(extra, res, success) 
if res and res.message_ and res.message_ == "USERNAME_NOT_OCCUPIED" then 
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ المعرف غير صحيح يرجى ارسال معرف صحيح', 1, 'md')
return false 
end
...
local Text = "𖢅⤈ تم ادخال المعرف ↫ ["..text.."]\n𖢅⤈ وتم اكتمال العدد الكلي هل انت مستعد ؟"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• نعم •",callback_data="/YesRolet"},{text="• لا •",callback_data="/NoRolet"}},{{text="• اللاعبين •",callback_data="/ListRolet"}}} 
Msg_id = msg.id_/2097152/0.5
return https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
local Text = "𖢅⤈ تم ادخال المعرف ↫ ["..text.."] وتبقى ↫ "..CountUser.." لاعبين ليكتمل العدد ارسل المعرف الاخر"
keyboard = {} 
...
Text = ''..DavidTeam[math.random(#DavidTeam)]..''
keyboard = {} 
keyboard.inline_keyboard = {{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح رسائلي •",callback_data="/DelMsg:"..msg.sender_user_id_},{text="• مسح سحكاتي •",callback_data="/DelEdit:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
...
local Tsl = DevRio:get(David..'Rio:Tsl')
local Text = [[
*𖢅⤈ اهلا بك في قائمة اوامر التسليه ↫ ⤈*
𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅
*𖢅⤈ غنيلي*
*𖢅⤈ اغنيه*
*𖢅⤈ متحركه*
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• غنيلي •",callback_data="/Song:"..msg.sender_user_id_},{text="• اغنيه •",callback_data="/mp3:"..msg.sender_user_id_}},{{text="• متحركه •",callback_data="/gif:"..msg.sender_user_id_},{text="• صوره •",callback_data="/photo:"..msg.sender_user_id_}},{{text="• انمي •",callback_data="/anime:"..msg.sender_user_id_},{text="• ريمكس •",callback_data="/remix:"..msg.sender_user_id_}},{{text="• ميمز •",callback_data="/memz:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text="• تنزيل مطور ثانوي •",callback_data=msg.sender_user_id_..":RemSecondSudo:"..result.sender_user_id_},{text="• تنزيل مطور اساسي •",callback_data=msg.sender_user_id_..":RemRioSudo:"..result.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif RioSudo(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..Rio}},{{text="• تنزيل مطور ثانوي •",callback_data=msg.sender_user_id_..":RemSecondSudo:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif Owner(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text = '• David TeAM •',url="t.me/SOURCEANUBIS"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
end
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text='..URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
--     Source David     --
if text == "الرابط" then
local Link = DevRio:get(David..'Rio:Link')
local Text = [[
*𖢅⤈ اختر نوع الرابط لجلبه*
]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الرابط نص •",callback_data="/LinkText:"..msg.sender_user_id_},{text="• الرابط انلاين •",callback_data="/Linkinline:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
...
if not DevRio:get(David..'Rio:Lock:Games'..msg.chat_id_) then
local Games = DevRio:get(David..'Rio:Games')
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الالعاب المتطوره •",callback_data="/GameInline:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ تم بيع '..(DevRio:get(David..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n𖢅⤈ كل نقطه تساوي 50 رساله', 'md')
...
if num == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لا يوجد ادمنيه ليتم رفعهم\n𖢅⤈ تم رفع مالك المجموعه", 1, 'md')
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم رفع '..num..' من الادمنيه \n𖢅⤈ تم رفع مالك المجموعه', 1, 'md')
end
end,nil) 
end
--     Source David     --
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ موقعك ↫ '..rtpa, 1, 'md')
end,nil)
end
--     Source David     --
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ اسمك ↫ ❨ ['..result.first_name_..'] ❩\n𖢅⤈ معرفك ↫ ❨ ['..username..'] ❩\n𖢅⤈ ايديك ↫ ❨ `'..result.id_..'` ❩\n𖢅⤈ نقاطك ↫ ❨ '..user_nkt..' ❩\n𖢅⤈ رسائلك ↫ ❨ '..user_msgs..' ❩\n𖢅⤈ جهاتك ↫ ❨ '..cont..' ❩\n𖢅⤈ تفاعلك ↫ '..formsgs(msguser)..'\n𖢅⤈ رتبتك ↫ '..IdRank(msg.sender_user_id_, msg.chat_id_), 1, 'md')
end
...
send(msg.chat_id_, msg.id_, '𖢅⤈ ارسل لي معرف قناة الاشتراك الان')
end
return false  
end
...
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevRio:get(David.."Rio:ChId"))
local GetInfo = JSON.decode(Check)
send(msg.chat_id_, msg.id_,"𖢅⤈ الاشتراك الاجباري مفعل \n𖢅⤈ على القناة ↫ [@"..GetInfo.result.username.."]")
else
DevRio:setex(David..'DevRio4'..msg.sender_user_id_,360,true)
send(msg.chat_id_, msg.id_,"𖢅⤈ لاتوجد قناة لتفعيل الاشتراك\n𖢅⤈ ارسل لي معرف قناة الاشتراك الان")
end
end
return false  
end
...
DevRio:del(David..'Rio:ChId')
Dev_Rio(msg.chat_id_, msg.id_, 1,"𖢅⤈ تم حذف قناة الاشتراك الاجباري", 1, 'md') 
end
end
if SecondSudo(msg) then
...
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevRio:get(David.."Rio:ChId"))
local GetInfo = JSON.decode(Check)
send(msg.chat_id_, msg.id_, "𖢅⤈ قناة الاشتراك ↫ [@"..GetInfo.result.username.."]")
else
send(msg.chat_id_, msg.id_, "𖢅⤈ لاتوجد قناة في الاشتراك الاجباري")
end
return false  
end end
--     Source David     --
...
function DavidTeam(extra,result,success)
if DevRio:get(David.."Rio:Send:Bot"..David) and not RioSudo(msg) then 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم اذاعة رسالتك بالتوجيه \n𖢅⤈ ‏في ↫ ❨ '..#GpList..' ❩ مجموعه \n𖢅⤈ والى ↫ ❨ '..#PvList..' ❩ مشترك \n ✓', 1, 'md')
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ حسنا قم باعادة توجيه للمنشور الذي تريدني حساب مشاهداته', 1, 'md')
end
--     Source David     --
...
Text = [[
Welcome To Source
𖢅⤈ [TeAm David](https://t.me/SOURCEANUBIS)
]]
keyboard = {} 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(David..'yes'..msg.sender_user_id_, 'delyes')
DevRio:set(David..'no'..msg.sender_user_id_, 'delno')
local Text = '𖢅⤈ هل انت متأكد من المغادره'
keyboard = {} 
...
local Text = '𖢅⤈ هل انت متأكد من تنزيلك'
keyboard = {} 
...
local user_msgs = DevRio:get(David..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ عدد رسائلك هنا ↫ *❨ "..user_msgs.." ❩*", 1, 'md')
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ انضمام الاعضاء اليوم ↫ *"..EntryNumber.."*\n𖢅⤈ مغادرة الاعضاء اليوم ↫ *"..ExitNumber.."*\n𖢅⤈ عدد الرسائل اليوم ↫ *"..MsgNumberDay.."*\n𖢅⤈ نسبة التفاعل اليوم ↫ *"..math.random(40,100).."%*", 1, 'md')
end
--     Source David     --
...
send(msg.chat_id_, msg.id_,"𖢅⤈ عدد رسائله الكلي هو ↬\n"..get_msg.." من الرسائل")
end  
...
--     Source David     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevRio:get(David..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevRio:get(David..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
if text == "رتبتي" and ChCheck(msg) then Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ رتبتك ↫ '..IdRank(msg.sender_user_id_, msg.chat_id_), 1, 'html') end
if text == "ايدي المجموعه" and ChCheck(msg) then Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ايدي المجموعه ↫ `"..msg.chat_id_.."`", 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevRio:del(David..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source David     --
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لاتستطيع تنزيل المطور الاساسي", 1, 'md')
return false 
end
...
if DevRio:sismember(David..'Rio:RioSudoGp:'..msg.chat_id_, result.sender_user_id_) then
riosudogp = 'مطورين اساسيين المجموعه • ' else riosudogp = '' end
if DevRio:sismember(David..'Rio:SecondSudoGp:'..msg.chat_id_, result.sender_user_id_) then
secondsudogp = 'ثانويين المجموعه • ' else secondsudogp = '' end
if DevRio:sismember(David..'Rio:SudoBotGp:'..msg.chat_id_, result.sender_user_id_) then
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله من ↫ ⤈\n~ ( "..riosudo..secondsudo..sudobot..riosudogp..secondsudogp..sudobotgp..owner..basicconstructor..constructor..manager..admins..vipmem..cleaner.." ) ~")  
else 
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ لم تتم ترقيته مسبقا")  
end
...
DevRio:srem(David..'Rio:RioSudoGp:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(David..'Rio:SecondSudoGp:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(David..'Rio:SudoBotGp:'..msg.chat_id_,result.sender_user_id_)
...
DevRio:srem(David..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(David..'Rio:SudoBotGp:'..msg.chat_id_,result.sender_user_id_)
elseif RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'riosudogp' then
DevRio:srem(David..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(David..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(David..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(David..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
DevRio:srem(David..'Rio:SecondSudoGp:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(David..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_)
elseif RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'secondsudogp' then
DevRio:srem(David..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(David..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(David..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(David..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
DevRio:srem(David..'Rio:SudoBotGp:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(David..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_)
elseif RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudobotgp' then
DevRio:srem(David..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(David..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(David..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(David..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(David..'Rio:RioSudoGp:'..msg.chat_id_, result.id_) then
riosudogp = 'مطورين اساسيين المجموعه • ' else riosudogp = '' end
if DevRio:sismember(David..'Rio:SecondSudoGp:'..msg.chat_id_, result.id_) then
secondsudogp = 'ثانويين المجموعه • ' else secondsudogp = '' end
if DevRio:sismember(David..'Rio:SudoBotGp:'..msg.chat_id_, result.id_) then
sudobotgp = 'مطورين المجموعه • ' else sudobotgp = '' end
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم تنزيله من ↫ ⤈\n~ ( "..riosudo..secondsudo..sudobot..riosudogp..secondsudogp..sudobotgp..owner..basicconstructor..constructor..manager..admins..vipmem..cleaner.." ) ~")  
else 
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ لم تتم ترقيته مسبقا")  
end 
if RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
...
DevRio:srem(David..'Rio:RioSudoGp:'..msg.chat_id_,result.id_)
DevRio:srem(David..'Rio:SecondSudoGp:'..msg.chat_id_,result.id_)
DevRio:srem(David..'Rio:SudoBotGp:'..msg.chat_id_,result.id_)
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه في قائمة المطورين الاساسيين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم رفعه في قائمة المطورين الاساسيين")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم رفعه في قائمة المطورين الاساسيين")  
end
--     Source David     --
--     Rem SecondSudo     --
...
function prom_reply(extra, result, success)
DevRio:srem(David..'Rio:RioSudo:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله من قائمة المطورين الاساسيين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
DevRio:srem(David..'Rio:RioSudo:',result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم تنزيله من قائمة المطورين الاساسيين")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم تنزيله من قائمة المطورين الاساسيين")  
end end
--     Source David     --
--     Set SecondSudo     --
if RioSudo(msg) then
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه في قائمة المطورين الثانويين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),sudo_reply)
end end 
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم رفعه في قائمة المطورين الثانويين")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم رفعه في قائمة المطورين الثانويين")  
end
--     Source David     --
--     Rem SecondSudo     --
...
function prom_reply(extra, result, success)
DevRio:srem(David..'Rio:SecondSudo:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله من قائمة المطورين الثانويين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
if result.id_ then
DevRio:srem(David..'Rio:SecondSudo:',result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم تنزيله من قائمة المطورين الثانويين")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم تنزيله من قائمة المطورين الثانويين")  
end end
--     Source David     --
--       Set SudoBot      --
if SecondSudo(msg) then
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه في قائمة المطورين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),sudo_reply)
end end 
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم رفعه في قائمة المطورين")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم رفعه في قائمة المطورين")  
end
--     Source David     --
--       Rem SudoBot      --
...
function prom_reply(extra, result, success)
DevRio:srem(David..'Rio:SudoBot:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله من قائمة المطورين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
if result.id_ then
DevRio:srem(David..'Rio:SudoBot:',result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم تنزيله من قائمة المطورين")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم تنزيله من قائمة المطورين")  
end end
--     Source David     --
--  Set RioSudoGp  --
if RioSudo(msg) then
...
DevRio:sadd(David..'Rio:RioSudoGp:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه مطور اساسي مجموعه")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(David..'Rio:RioSudoGp:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه مطور اساسي مجموعه")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
...
DevRio:sadd(David..'Rio:RioSudoGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه مطور اساسي مجموعه")  
end
--     Source David     --
--  Rem RioSudoGp  --
...
function prom_reply(extra, result, success)
DevRio:srem(David..'Rio:RioSudoGp:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله مطور اساسي مجموعه")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
DevRio:srem(David..'Rio:RioSudoGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله مطور اساسي مجموعه")  
end end
if text ==('رفع مطور اساسي مجموعه') and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ هذا الامر للمطورين فقط', 1, 'md')
end
--     Source David     --
--  Set SecondSudoGp  --
if RioSudoGp(msg) then
if text ==('رفع ثانوي مجموعه') and ChCheck(msg) then
function raf_reply(extra, result, success)
DevRio:sadd(David..'Rio:SecondSudoGp:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه مطور ثانوي مجموعه")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
end end
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(David..'Rio:SecondSudoGp:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه مطور ثانوي مجموعه")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
...
DevRio:sadd(David..'Rio:SecondSudoGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه مطور ثانوي مجموعه")  
end
--     Source David     --
--  Rem SecondSudoGp  --
...
function prom_reply(extra, result, success)
DevRio:srem(David..'Rio:SecondSudoGp:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله مطور ثانوي مجموعه")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
DevRio:srem(David..'Rio:SecondSudoGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله مطور ثانوي مجموعه")  
end end
if text ==('رفع ثانوي مجموعه') and not RioSudoGp(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ هذا الامر للمطورين فقط', 1, 'md')
end
--     Source David     --
--  Set SudoBotGp  --
...
function raf_reply(extra, result, success)
DevRio:sadd(David..'Rio:SudoBotGp:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه مطور مجموعه")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
end end
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(David..'Rio:SudoBotGp:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه مطور مجموعه")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
...
DevRio:sadd(David..'Rio:SudoBotGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه مطور مجموعه")  
end
--     Source David     --
--  Rem SudoBotGp  --
...
function prom_reply(extra, result, success)
DevRio:srem(David..'Rio:SudoBotGp:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله مطور مجموعه")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
DevRio:srem(David..'Rio:SudoBotGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله مطور مجموعه")  
end end
...
function raf_reply(extra, result, success)
DevRio:sadd(David..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه مالك")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
end end
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(David..'Rio:Owner:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم رفعه مالك")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
DevRio:sadd(David..'Rio:Owner:'..msg.chat_id_,user)
ReplyStatus(msg,user,"Reply","𖢅⤈ تم رفعه مالك")  
end
--     Source David     --
--   Rem RioConstructor   --
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا يمكن تنزيل المالك الاساسي', 1, 'md')
else
DevRio:srem(David..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله من المالكين")  
end end end
end,nil)
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
...
DevRio:srem(David..'Rio:Owner:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم تنزيله من المالكين")  
end end end
end,nil)
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
...
DevRio:srem(David..'Rio:Owner:'..msg.chat_id_,user)
ReplyStatus(msg,user,"Reply","𖢅⤈ تم تنزيله من المالكين")  
end end end
end,nil)
end end
--     Source David     --
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
DevRio:sadd(David..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه منشئ اساسي")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
end end
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم رفعه منشئ اساسي")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم رفعه منشئ اساسي")  
end
--     Source David     --
...
function prom_reply(extra, result, success)
DevRio:srem(David..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله منشئ اساسي")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
if result.id_ then
DevRio:srem(David..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم تنزيله منشئ اساسي")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم تنزيله منشئ اساسي")  
end end
if text ==('رفع منشئ اساسي') and not Owner(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ هذا الامر للمالكين والمطورين فقط', 1, 'md')
end
--     Source David     --
--    Set  Constructor    --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه في قائمة المنشئين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
end end
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم رفعه في قائمة المنشئين")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم رفعه في قائمة المنشئين")  
end
--     Source David     --
--    Rem  Constructor    --
...
function prom_reply(extra, result, success)
DevRio:srem(David..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله من قائمة المنشئين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
if result.id_ then
DevRio:srem(David..'Rio:Constructor:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم تنزيله من قائمة المنشئين")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم تنزيله من قائمة المنشئين")  
end 
end
--     Source David     --
--      Set Manager       --
...
DevRio:sadd(David..'Rio:Managers:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه في قائمة المدراء")  
end  
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
if result.id_ then
DevRio:sadd(David..'Rio:Managers:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم رفعه في قائمة المدراء")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم رفعه في قائمة المدراء")  
end
--     Source David     --
--       Rem Manager      --
...
function prom_reply(extra, result, success)
DevRio:srem(David..'Rio:Managers:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله من قائمة المدراء")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
if result.id_ then
DevRio:srem(David..'Rio:Managers:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم تنزيله من قائمة المدراء")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم تنزيله من قائمة المدراء")  
end 
--     Source David     --
--       Set Cleaner      --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه في قائمة المنظفين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم رفعه في قائمة المنظفين")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم رفعه في قائمة المنظفين")  
end
--     Source David     --
--       Rem Cleaner      --
...
function prom_reply(extra, result, success)
DevRio:srem(David..'Rio:Cleaner:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله من قائمة المنظفين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
if result.id_ then
DevRio:srem(David..'Rio:Cleaner:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم تنزيله من قائمة المنظفين")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم تنزيله من قائمة المنظفين")  
end end
--     Source David     --
--       Set admin        --
if Manager(msg) then
...
DevRio:sadd(David..'Rio:Admins:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه في قائمة الادمنيه")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
if result.id_ then
DevRio:sadd(David..'Rio:Admins:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم رفعه في قائمة الادمنيه")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم رفعه في قائمة الادمنيه")  
end
--     Source David     --
--        Rem admin       --
...
function prom_reply(extra, result, success)
DevRio:srem(David..'Rio:Admins:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله من قائمة الادمنيه")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
if result.id_ then
DevRio:srem(David..'Rio:Admins:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم تنزيله من قائمة الادمنيه")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم تنزيله من قائمة الادمنيه")  
end end
--     Source David     --
--       Set Vipmem       --
if Admin(msg) then
...
DevRio:sadd(David..'Rio:VipMem:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه في قائمة المميزين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
if result.id_ then
DevRio:sadd(David..'Rio:VipMem:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم رفعه في قائمة المميزين")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم رفعه في قائمة المميزين")  
end
--     Source David     --
--       Rem Vipmem       --
...
function prom_reply(extra, result, success)
DevRio:srem(David..'Rio:VipMem:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله من قائمة المميزين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
if result.id_ then
DevRio:srem(David..'Rio:VipMem:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم تنزيله من قائمة المميزين")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم تنزيله من قائمة المميزين")  
end end 
--     Source David     --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه مشرف في المجموعه")  
else
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ ليست لدي صلاحية اضافة مشرفين جدد يرجى التحقق من الصلاحيات', 1, 'md')
end
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله من مشرفين المجموعه")  
else
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ ليست لدي صلاحية اضافة مشرفين جدد يرجى التحقق من الصلاحيات', 1, 'md')
end
end
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه مشرف في جميع الصلاحيات")  
else
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ ليست لدي صلاحية اضافة مشرفين جدد يرجى التحقق من الصلاحيات', 1, 'md')
end
end
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم اضافة ↫ "..Rio.." كلقب له")  
...
send(msg.chat_id_, msg.id_,'𖢅⤈ ليس لديه لقب هنا') 
else
send(msg.chat_id_, msg.id_,'𖢅⤈ لقبه ↫ '..GetCustomTitle(result.sender_user_id_,msg.chat_id_)) 
end
end
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
...
if GetCustomTitle(msg.sender_user_id_,msg.chat_id_) == false then
send(msg.chat_id_, msg.id_,'𖢅⤈ ليس لديك لقب هنا') 
else
send(msg.chat_id_, msg.id_,'𖢅⤈ لقبك ↫ '..GetCustomTitle(msg.sender_user_id_,msg.chat_id_)) 
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم تفعيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم تعطيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
end
--     Source David     --
--          Kick          --
...
send(msg.chat_id_, msg.id_,'𖢅⤈ لقد تم تعطيل الطرد والحظر من قبل مالك المجموعه')
return false
end
if RankChecking(result.sender_user_id_, result.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا تستطيع طرد ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
...
send(msg.chat_id_,msg.id_,"𖢅⤈ لا استطيع طرد مشرفين المجموعه") 
return false  
end
ChatKick(result.chat_id_, result.sender_user_id_)
text = "𖢅⤈ تم طرده من المجموعه" 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء حظر •",callback_data=msg.sender_user_id_..":UnBan:"..result.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا تستطيع طرد ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم طرده من المجموعه")  
end,nil)
end
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا تستطيع طرد ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم طرده من المجموعه")  
end,nil)
end
end
end 
...
if RankChecking(result.sender_user_id_, result.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا تستطيع حظر ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=result.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"𖢅⤈ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
...
if dp and dp.code_ and dp.code_ == 400 and dp.message_ == "USER_ADMIN_INVALID" then 
send(msg.chat_id_,msg.id_,"𖢅⤈ لا استطيع حظر مشرفين المجموعه") 
return false  
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevRio:sadd(David..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
text = "𖢅⤈ تم حظره من المجموعه" 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء حظر •",callback_data=msg.sender_user_id_..":UnBan:"..result.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا تستطيع حظر ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=result.id_,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"𖢅⤈ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم حظره من المجموعه")  
end,nil) 
end
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
...
if RankChecking(user, msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا تستطيع حظر ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=user,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"𖢅⤈ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم حظره من المجموعه")  
end,nil) 
end
end
--     Source David     --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم الغاء حظره من المجموعه")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم الغاء حظره من المجموعه")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم الغاء حظره من المجموعه")  
end 
end 
--     Source David     --
--          Mute          --
...
send(msg.chat_id_, msg.id_,'𖢅⤈ لقد تم تعطيل الكتم والتقيد')
return false
end
if RankChecking(result.sender_user_id_, result.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا تستطيع كتم ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
if DevRio:sismember(David..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(David..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
text = "𖢅⤈ تم كتمه من المجموعه" 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء كتم •",callback_data=msg.sender_user_id_..":UnMute:"..result.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا تستطيع كتم ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
if DevRio:sismember(David..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(David..'Rio:Muted:'..msg.chat_id_, result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم كتمه من المجموعه")  
end
end
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
...
if RankChecking(user, msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا تستطيع كتم ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
if DevRio:sismember(David..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","𖢅⤈ هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(David..'Rio:Muted:'..msg.chat_id_, user)
ReplyStatus(msg,user,"Reply","𖢅⤈ تم كتمه من المجموعه")  
end
end
end
--     Source David     --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(David..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم الغاء كتمه من المجموعه")  
end
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(David..'Rio:Muted:'..msg.chat_id_, result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم الغاء كتمه من المجموعه")  
end
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","𖢅⤈ هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(David..'Rio:Muted:'..msg.chat_id_, user)
ReplyStatus(msg,user,"Reply","𖢅⤈ تم الغاء كتمه من المجموعه")  
end
end 
end 
--     Source David     --
...
if RankChecking(result.sender_user_id_, result.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا تستطيع تقيد ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_)
DevRio:sadd(David..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
text = "𖢅⤈ تم تقيده من المجموعه" 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء تقيد •",callback_data=msg.sender_user_id_..":UnTkeed:"..result.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end 
...
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا تستطيع تقيد ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.id_)
DevRio:sadd(David..'Rio:Tkeed:'..msg.chat_id_, result.id_)
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم تقيده من المجموعه")  
end
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
...
if RankChecking(user, msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا تستطيع تقيد ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..user)
DevRio:sadd(David..'Rio:Tkeed:'..msg.chat_id_, user)
ReplyStatus(msg,user,"Reply","𖢅⤈ تم تقيده من المجموعه")  
end
end
--     Source David     --
--         UnTkeed          --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم الغاء تقيده من المجموعه")  
end
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم الغاء تقيده من المجموعه")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم الغاء تقيده من المجموعه")  
end
end 
end
--     Source David     --
...
if tonumber(result.sender_user_id_) == tonumber(David) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ *لاتستطيع حظر البوت عام*", 1, 'md')
return false 
end
if SudoId(result.sender_user_id_) == true then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ *لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
...
text = "𖢅⤈ تم حظره عام من المجموعات" 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء العام •",callback_data=msg.sender_user_id_..":UnAll:"..result.sender_user_id_},{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم حظره عام من المجموعات")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم حظره عام من المجموعات")  
end
--     Source David     --
--         MuteAll        --
...
if tonumber(result.sender_user_id_) == tonumber(David) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ *لاتستطيع كتم البوت عام*", 1, 'md')
return false 
end
if SudoId(result.sender_user_id_) == true then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ *لاتستطيع كتم المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(David..'Rio:RioSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ *لاتستطيع كتم المطور الاساسي*", 1, 'md')
...
text = "𖢅⤈ تم كتمه عام من المجموعات" 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء العام •",callback_data=msg.sender_user_id_..":UnAll:"..result.sender_user_id_},{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم كتمه عام من المجموعات")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم كتمه عام من المجموعات")  
end
--     Source David     --
--         UnAll          --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم الغاء (الحظر • الكتم) عام من المجموعات")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم الغاء (الحظر • الكتم) عام من المجموعات")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","𖢅⤈ تم الغاء (الحظر • الكتم) عام من المجموعات")  
end
end
end
--     Source David     --
...
send(msg.chat_id_, msg.id_,'𖢅⤈ يجب التاكد ان المطور الجديد ارسل start لخاص البوت بعد ذلك يمكنك ارسال ايدي المطور')
DevRio:setex(David.."Rio:EditDev"..msg.sender_user_id_,300,true)
end
if DevRio:get(David.."Rio:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'𖢅⤈ تم الغاء امر تغير المطور الاساسي')
...
if dp.username_ ~= false then DevUser = '\n𖢅⤈ المعرف ↫ [@'..dp.username_..']' else DevUser = '' end
local Text = '𖢅⤈ الايدي ↫ '..dp.id_..DevUser..'\n𖢅⤈ الاسم ↫ ['..dp.first_name_..'](tg://user?id='..dp.id_..')\n𖢅⤈ تم حفظ المعلومات بنجاح\n𖢅⤈ استخدم الازرار للتاكيد ↫ ⤈'
keyboard = {} 
keyboard.inline_keyboard = {{{text="• نعم •",callback_data="/setyes"},{text="• لا •",callback_data="/setno"}}} 
Msg_id = msg.id_/2097152/0.5
return https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
send(msg.chat_id_, msg.id_,"𖢅⤈ المعلومات خاطئه قم بالتاكد واعد المحاوله")
DevRio:del(David.."Rio:EditDev"..msg.sender_user_id_)
end
end,nil)
return false
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفعه في قائمة المطايه") 
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ هو ليس مطي ليتم تنزيله") 
else
DevRio:srem(David..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تنزيله من قائمة المطايه") 
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source David     --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تقيده لمدة ↫ "..mutept.." د") 
DevRio:sadd(David..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
end end 
...
https.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+num1))
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تقيده لمدة ↫ "..mutept.." س") 
DevRio:sadd(David..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
end end
if tonumber(msg.reply_to_message_id_) == 0 then else
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, mut_time,nil) end 
...
https.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+num1))
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم تقيده لمدة ↫ "..mutept.." ي") 
DevRio:sadd(David..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
end end
if tonumber(msg.reply_to_message_id_) == 0 then else
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, mut_time,nil) end 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل عدد الرسائل الان \n𖢅⤈ ارسل الغاء لالغاء الامر ", 1, "md")
Dev_Rio(msg.chat_id_, msg.id_, 1,numd, 1, 'md') 
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ هذا الامر للمنشئين فقط', 1, 'md') 
end 
end 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم اضافة "..Num..' رساله', 1, 'md') 
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل عدد النقاط الان \n𖢅⤈ ارسل الغاء لالغاء الامر ", 1, "md")
Dev_Rio(msg.chat_id_, msg.id_, 1,numd, 1, 'md') 
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ هذا الامر للمنشئين فقط', 1, 'md') 
end 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
...
if DevRio:get(David..'Rio:Lock:CleanMusic'..msg.chat_id_) then if msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(David.."Rio:cleanermusic"..msg.chat_id_, msg.id_) else DevRio:sadd(David.."Rio:cleanermusic"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevRio:sismember(David.."Rio:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
Dev_Rio(msg.chat_id_,msg.id_, 1, "𖢅⤈ التثبيت والغاء واعادة التثبيت تم قفله من قبل المنشئين الاساسيين", 1, 'md')
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub("-100",""),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
DevRio:set(David..'Rio:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تثبيت الرساله بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
return false  
end
if data.code_ == 6 then
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ البوت ليس ادمن هنا !', 1, 'md')
return false  
end
if data.message_ == "CHAT_ADMIN_REQUIRED" then
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات', 1, 'md')
return false  
end
end,nil)
end 
...
if #List == 0 then 
text = "𖢅⤈ *لا يوجد مميزين*"
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source David     --
...
if #List == 0 then
text = "𖢅⤈ *لا يوجد ادمنيه*"
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source David     -- 
...
if #List == 0 then 
text = "𖢅⤈ *لا يوجد مدراء*"
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
if text == "المنظفين" and ChCheck(msg) then 
local List = DevRio:smembers(David..'Rio:Cleaner:'..msg.chat_id_)
text = "𖢅⤈ قائمة المنظفين ↫ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n"
for k,v in pairs(List) do
local username = DevRio:get(David..'Save:UserName'..v)
if username then
text = text..k.."~ : [@"..username.."]\n"
...
if #List == 0 then 
text = "𖢅⤈ *لا يوجد منظفين*"
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المنظفين •",callback_data="/DelCleanr:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source David     --
...
if #List == 0 then 
text = "𖢅⤈ *لا يوجد منشئين*"
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source David     --
...
local List = DevRio:smembers(David..'Rio:Owner:'..msg.chat_id_)
text = "𖢅⤈ قائمة المالكين ↫ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n"
for k,v in pairs(List) do
local username = DevRio:get(David..'Save:UserName'..v)
if username then
text = text..k.."~ : [@"..username.."]\n"
...
if #List == 0 then 
text = "𖢅⤈ *لا يوجد مالكين*"
end 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "المنشئين الاساسيين" and ChCheck(msg) or text == "منشئين اساسيين" and ChCheck(msg) or text == "المنشئين الاساسين" and ChCheck(msg) then 
local List = DevRio:smembers(David..'Rio:BasicConstructor:'..msg.chat_id_)
text = "𖢅⤈ قائمة المنشئين الاساسيين ↫ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n"
for k,v in pairs(List) do
local username = DevRio:get(David..'Save:UserName'..v)
if username then
text = text..k.."~ : [@"..username.."]\n"
...
if dp.first_name_ == false then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ حساب المنشئ محذوف", 1, "md")
return false  
end
local msg_id = msg.id_/2097152/0.5
Text = "*𖢅⤈ Owner Name ↬ * ["..dp.first_name_.."](T.me/"..dp.username_..")\n*𖢅⤈ Owner User ↬* [@"..dp.username_.."]\n*𖢅⤈ Owner id ↬* ["..dp.id_.."](T.me/"..dp.username_..")"
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..dp.first_name_..' ',url="t.me/"..dp.username_ or SOURCEANUBIS}}}
...
if #List == 0 then 
text = "𖢅⤈ *لا يوجد مكتومين*"
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المكتومين •",callback_data="/DelMute:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
if #List == 0 then
text = "𖢅⤈ *لا يوجد مقيدين*"
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المقيدين •",callback_data="/DelKeed:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
if #List == 0 then 
text = "𖢅⤈ *لا يوجد محظورين*"
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المحظورين •",callback_data="/DelBan:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
if #List == 0 then
text = "𖢅⤈ *لا يوجد مطايه كلها اوادم*"
end
Dev_Rio(msg.chat_id_, msg.id_, 1, text, 1, "md")
end
--     Source David     --
...
text = "𖢅⤈ قائمة المطورين الاساسيين ↫ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n"
for k,v in pairs(List) do
local username = DevRio:get(David..'Save:UserName'..v)
if username then
text = text..""..k.."~ : [@"..username.."]\n"
...
if #List == 0 then
text = "𖢅⤈ *عذرا لم يتم رفع اي مطورين اساسيين*"
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelRioSudo:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source David     --
...
text = "𖢅⤈ قائمة المطورين الثانويين ↫ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n"
for k,v in pairs(List) do
local username = DevRio:get(David..'Save:UserName'..v)
if username then
text = text..k.."~ : [@"..username.."]\n"
...
if #List == 0 then
text = "𖢅⤈ *عذرا لم يتم رفع اي مطورين ثانويين*"
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
if #MuteAll ~= 0 then 
text = text.."𖢅⤈ قائمة المكتومين عام ↫ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n"
...
text = "𖢅⤈ *لم يتم حظر او كتم اي عضو*"
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح قائمه العام •",callback_data="/DelListAll:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source David     --
...
if #List == 0 then
text = "𖢅⤈ *عذرا لم يتم رفع اي مطورين*"
end 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
local UserName = (dp.username_ or "SOURCEANUBIS")
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم رفع مالك المجموعه ↫ ["..dp.first_name_.."](T.me/"..UserName..")", 1, "md") 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم منع الملصق بنجاح لن يتم ارساله مجددا', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevRio:sadd(David.."Rio:FilterPhoto"..msg.chat_id_,photo)
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم منع الصوره بنجاح لن يتم ارسالها مجددا', 1, 'md')
return false
end
if result.content_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevRio:sadd(David.."Rio:FilterAnimation"..msg.chat_id_,idanimation)
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم منع المتحركه بنجاح لن يتم ارسالها مجددا', 1, 'md')
return false
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevRio:srem(David.."Rio:FilterPhoto"..msg.chat_id_,photo)
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevRio:srem(David.."Rio:FilterAnimation"..msg.chat_id_,idanimation)
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء منع المتحركه يمكنهم ارسالها الان', 1, 'md')
return false
end
end
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1,nil, './'..msg.sender_user_id_..'.jpg','𖢅⤈ تم تحويل الملصق الى صوره')     
...
sendVoice(msg.chat_id_, msg.id_, 0, 1,nil, './'..msg.sender_user_id_..'.ogg',"𖢅⤈ تم تحويل الـMp3 الى بصمه")
...
sudobot = '\n𖢅⤈ عدد الجروبات ↫ '..(DevRio:get(David..'Rio:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
if GetCustomTitle(result.sender_user_id_,msg.chat_id_) ~= false then
CustomTitle = '\n𖢅⤈ لقبه ↫ '..GetCustomTitle(result.sender_user_id_,msg.chat_id_)
else 
CustomTitle = '' 
end
...
return false  end
if data.username_ == false then
Text = '𖢅⤈ اسمه ↫ ['..data.first_name_..'](tg://user?id='..result.sender_user_id_..')\n𖢅⤈ ايديه ↫ ❨ `'..result.sender_user_id_..'` ❩\n𖢅⤈ رتبته ↫ '..IdRank(result.sender_user_id_, msg.chat_id_)..sudobot..'\n𖢅⤈ رسائله ↫ ❨ '..user_msgs..' ❩\n𖢅⤈ تفاعله ↫ '..formsgs(user_msgs)..CustomTitle..'\n𖢅⤈ نقاطه ↫ ❨ '..user_nkt..' ❩'..Tked
SendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
else
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ معرفه ↫ [@'..data.username_..']\n𖢅⤈ ايديه ↫ ❨ `'..result.sender_user_id_..'` ❩\n𖢅⤈ رتبته ↫ '..IdRank(result.sender_user_id_, msg.chat_id_)..sudobot..'\n𖢅⤈ رسائله ↫ ❨ '..user_msgs..' ❩\n𖢅⤈ تفاعله ↫ '..formsgs(user_msgs)..CustomTitle..'\n𖢅⤈ نقاطه ↫ ❨ '..user_nkt..' ❩'..Tked, 1, 'md')
end
end,nil)
end 
...
local ch = 'قناة'
local chn = '𖢅⤈ نوع الحساب ↫ ❨ '..ch..' ❩\n𖢅⤈ الايدي ↫ ❨ `'..res.id_..'` ❩\n𖢅⤈ المعرف ↫ ❨ [@'..username..'] ❩\n𖢅⤈ الاسم ↫ ❨ ['..res.title_..'] ❩'
Dev_Rio(msg.chat_id_, msg.id_, 1,chn, 1, 'md')
else
local gr = 'مجموعه'
local grr = '𖢅⤈ نوع الحساب ↫ ❨ '..gr..' ❩\n𖢅⤈ الايدي ↫ ❨ '..res.id_..' ❩\n𖢅⤈ المعرف ↫ ❨ [@'..username..'] ❩\n𖢅⤈ الاسم ↫ ❨ ['..res.title_..'] ❩'
...
sudobot = '\n𖢅⤈ عدد الجروبات ↫ '..(DevRio:get(David..'Rio:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
if GetCustomTitle(res.id_,msg.chat_id_) ~= false then
CustomTitle = '\n𖢅⤈ لقبه ↫ '..GetCustomTitle(res.id_,msg.chat_id_)
else 
CustomTitle = '' 
end
if data.first_name_ == false then
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ الحساب محذوف', 1, 'md')
return false  end
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ معرفه ↫ [@'..data.username_..']\n𖢅⤈ ايديه ↫ ❨ `'..res.id_..'` ❩\n𖢅⤈ رتبته ↫ '..IdRank(res.id_, msg.chat_id_)..sudobot..'\n𖢅⤈ رسائله ↫ ❨ '..user_msgs..' ❩\n𖢅⤈ تفاعله ↫ '..formsgs(user_msgs)..CustomTitle..'\n𖢅⤈ نقاطه ↫ ❨ '..user_nkt..' ❩'..Tked, 1, 'md')
end,nil)
end 
end,nil)
return false 
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ لم يتم التعرف على الحساب', 1, 'md')
return false  
end
...
sudobot = '\n𖢅⤈ عدد الجروبات ↫ '..(DevRio:get(David..'Rio:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
if GetCustomTitle(iduser,msg.chat_id_) ~= false then
CustomTitle = '\n𖢅⤈ لقبه ↫ '..GetCustomTitle(iduser,msg.chat_id_)
else 
CustomTitle = '' 
end
if data.first_name_ == false then
...
return false  end
if data.username_ == false then
Text = '𖢅⤈ اسمه ↫ ['..data.first_name_..'](tg://user?id='..iduser..')\n𖢅⤈ ايديه ↫ ❨ `'..iduser..'` ❩\n𖢅⤈ رتبته ↫ '..IdRank(data.id_, msg.chat_id_)..sudobot..'\n𖢅⤈ رسائله ↫ ❨ '..user_msgs..' ❩\n𖢅⤈ تفاعله ↫ '..formsgs(user_msgs)..CustomTitle..'\n𖢅⤈ نقاطه ↫ ❨ '..user_nkt..' ❩'..Tked
SendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
else
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ معرفه ↫ [@'..data.username_..']\n𖢅⤈ ايديه ↫ ❨ `'..iduser..'` ❩\n𖢅⤈ رتبته ↫ '..IdRank(data.id_, msg.chat_id_)..sudobot..'\n𖢅⤈ رسائله ↫ ❨ '..user_msgs..' ❩\n𖢅⤈ تفاعله ↫ '..formsgs(user_msgs)..CustomTitle..'\n𖢅⤈ نقاطه ↫ ❨ '..user_nkt..' ❩'..Tked, 1, 'md')
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الحظر العام ↫ '..banall..'\n𖢅⤈ الكتم العام ↫ '..muteall..'\n𖢅⤈ الحظر ↫ '..banned..'\n𖢅⤈ الكتم ↫ '..muted..'\n𖢅⤈ التقيد ↫ '..tkeed, 1, 'md')  
end
...
function unbanreply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(David) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ انا البوت وليس لدي قيود', 1, 'md')  
return false  
end 
ReplyStatus(msg,result.sender_user_id_,"Reply","𖢅⤈ تم رفع قيوده") 
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لم استطع استخراج المعلومات', 1, 'md') 
return false  
end
ReplyStatus(msg,user,"Reply","𖢅⤈ تم رفع قيوده") 
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ هذا معرف قناة وليس معرف حساب', 1, 'md') 
return false  
end
if tonumber(result.id_) == tonumber(David) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ انا البوت وليس لدي قيود', 1, 'md')  
...
ReplyStatus(msg,result.id_,"Reply","𖢅⤈ تم رفع قيوده") 
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم تغير كليشة الايدي")  
end
--     Source David     --
if SecondSudo(msg) then
if text and text:match("^تعيين الايدي العام$") or text and text:match("^تعين الايدي العام$") or text and text:match("^تعيين كليشة الايدي$") then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ رجائا اتبع التعليمات للتعيين \n𖢅⤈ لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅', 1, 'md')
...
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("David:New:id:"..David..msg.sender_user_id_)
return false
end
DevRio:del("David:New:id:"..David..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم حفظ كليشة الايدي العامه', 1, 'md')
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف كليشة الايدي العامه")  
...
DevRio:del("David:New:id:"..David..msg.chat_id_..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم حفظ الكليشه الجديده', 1, 'md')
DevRio:set(David.."Rio:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف كليشة الايدي")  
...
notpicid = "𖢅⤈ لا استطيع عرض صورتك لانك قمت بحظر البوت او انك لاتمتلك صوره في بروفايلك\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ معرفك ↫ ❨ "..username.." ❩\n𖢅⤈ ايديك ↫ ❨ "..msg.sender_user_id_.." ❩\n𖢅⤈ رتبتك ↫ "..IdRank(msg.sender_user_id_, msg.chat_id_).."\n𖢅⤈ رسائلك ↫ ❨ "..user_msgs.." ❩\n𖢅⤈ سحكاتك ↫ ❨ "..edit_msg.." ❩\n𖢅⤈ تفاعلك ↫ "..formsgs(msguser).."\n𖢅⤈ نقاطك ↫ ❨ "..user_nkt.." ❩\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n"
end 
if not DevRio:get(David..'Rio:Lock:Id'..msg.chat_id_) then
if not DevRio:get(David..'Rio:Lock:Id:Photo'..msg.chat_id_) then
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل التعديل")  
DevRio:set(David..'Rio:Lock:EditMsgs'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ التعديل بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "التعديل الميديا" or LockText[2] == "تعديل الميديا" then
if not DevRio:get(David..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل تعديل الميديا")  
DevRio:set(David..'Rio:Lock:EditMsgs'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تعديل الميديا بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الفارسيه" then
if not DevRio:get(David..'Rio:Lock:Farsi'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الفارسيه")  
DevRio:set(David..'Rio:Lock:Farsi'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الفارسيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الفشار" then
if DevRio:get(David..'Rio:Lock:Fshar'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الفشار")  
DevRio:del(David..'Rio:Lock:Fshar'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الفشار بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الطائفيه" then
if DevRio:get(David..'Rio:Lock:Taf'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الطائفيه")  
DevRio:del(David..'Rio:Lock:Taf'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الطائفيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الكفر" then
if DevRio:get(David..'Rio:Lock:Kfr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الكفر")  
DevRio:del(David..'Rio:Lock:Kfr'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الكفر بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الفارسيه بالطرد" then
if not DevRio:get(David..'Rio:Lock:FarsiBan'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الفارسيه بالطرد")  
DevRio:set(David..'Rio:Lock:FarsiBan'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الفارسيه بالطرد بالفعل مقفله ', 1, 'md')
end
end
if LockText[2] == "البوتات" or LockText[2] == "البوتات بالحذف" then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل البوتات بالحذف")  
DevRio:set(David.."Rio:Lock:Bots"..msg.chat_id_,"del")  
end
if LockText[2] == "البوتات بالطرد" then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل البوتات بالطرد")  
DevRio:set(David.."Rio:Lock:Bots"..msg.chat_id_,"kick")  
end
if LockText[2] == "البوتات بالتقييد" or LockText[2] == "البوتات بالتقيد" then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل البوتات بالتقيد")  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevRio:hset(David.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل التكرار بالطرد")  
end
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevRio:hset(David.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل التثبيت")  
DevRio:set(David..'Rio:Lock:Pin'..msg.chat_id_,true)
DevRio:sadd(David.."Rio:Lock:Pinpin",msg.chat_id_) 
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ التثبيت بالفعل مقفل في المجموعه', 1, 'md')
end end end
end
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ قم بتحديد عدد اكبر من 2 للتكرار', 1, 'md')
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم وضع عدد التكرار ↫ '..TextSpam, 1, 'md')
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم وضع زمن التكرار ↫ '..TextSpam, 1, 'md')
end
--     Source David     --
if Manager(msg) then
if text and text == 'تفعيل الايدي بالصوره' and ChCheck(msg) then
if not DevRio:get(David..'Rio:Lock:Id:Photo'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الايدي بالصوره بالتاكيد مفعل', 1, 'md')
else
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تفعيل الايدي بالصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
...
if not DevRio:get(David..'Rio:Lock:Id'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الايدي بالتاكيد مفعل ', 1, 'md')
else
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تفعيل الايدي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(David..'Rio:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevRio:get(David..'Rio:Lock:Id'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الايدي بالتاكيد معطل ', 1, 'md')
else
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تعطيل الايدي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ ارسل رابط المجموعه او رابط قناة المجموعه', 1, 'md')
...
LinkGroup = LinkGp.result
DevRio:set(David.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم انشاء رابط جديد ارسل ↫ الرابط', 1, 'md')
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ ليست لدي صلاحية دعوة المستخدمين عبر الرابط يرجى التحقق من الصلاحيات', 1, 'md')
end
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ ارسل رابط المجموعه او رابط قناة المجموعه', 1, 'md')
DevRio:setex(David.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم حفظ كليشة الترحيب', 1, 'md')
return false   
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ ارسل لي الترحيب الان\n𖢅⤈ تستطيع اضافة مايلي ↫ ⤈\n𖢅⤈ دالة عرض الاسم ↫ firstname\n𖢅⤈ دالة عرض المعرف ↫ username', 1, 'md')
DevRio:set(David..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف الترحيب")  
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لم يتم وضع الترحيب \n𖢅⤈ ارسل ↫ ضع ترحيب للحفظ ', 1, 'md')
end
end
--     Source David     --
if DevRio:get(David..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم الغاء حفظ الوصف", 1, 'md')
DevRio:del(David..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(David..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
https.request('https://api.telegram.org/bot'..TokenBot..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم تغيير وصف المجموعه', 1, 'md')
return false  
end 
if text and text:match("^ضع وصف$") and ChCheck(msg) or text and text:match("^وضع وصف$") and ChCheck(msg) then  
DevRio:set(David..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ ارسل لي الوصف الان', 1, 'md')
end
--     Source David     --
if text and text == "منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل لي الكلمه الان", 1, 'md') 
...
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء امر المنع', 1, 'md')
DevRio:del(David.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم منع الكلمه ↫ "..text, 1, 'html')
DevRio:del(David.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
...
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء امر الغاء المنع', 1, 'md')
DevRio:del(David.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevRio:hget(David..'Rio:Filters:'..msg.chat_id_, text) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevRio:del(David.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevRio:hdel(David..'Rio:Filters:'..msg.chat_id_, text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ الكلمه ↫ "..text.." تم الغاء منعها", 1, 'html')
DevRio:del(David.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
end
return false
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ احصائيات البوت ↫ ⤈\n𖢅⤈ عدد المشتركين ↫ ❨ '..users..' ❩\n𖢅⤈ عدد المجموعات ↫ ❨ '..gps..' ❩', 1, 'md')
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ عدد المشتركين ↫ ❨ '..users..' ❩', 1, 'md')
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ عدد المجموعات ↫ ❨ '..gps..' ❩', 1, 'md')
end
end
--     Source David     --
if text and text == "المجموعات" and ChCheck(msg) or text and text == "↫ المجموعات ᥀" and ChCheck(msg) then
if not SudoBot(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ للمطورين فقط ', 1, 'md')
else
local list = DevRio:smembers(David.."Rio:Groups")
local t = '𖢅⤈ مجموعات البوت ↫ ⤈ \n'
for k,v in pairs(list) do
t = t..k.."~ : `"..v.."`\n" 
end
if #list == 0 then
t = '𖢅⤈ لا يوجد مجموعات مفعله'
end
...
if Number > 5000 then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لاتستطيع تنظيف اكثر من 5000 رساله', 1, 'md')
return false  
end  
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم تنظيف *'..Number..'* من الرسائل', 1, 'md')
...
if #pv == i then 
if sendok == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ *لا يوجد مشتركين وهميين*', 1, 'md')
else
local ok = #pv - sendok
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ عدد المشتركين الان ↫ { '..#pv..' }\n𖢅⤈ تم حذف ↫ { '..sendok..' } من المشتركين\n𖢅⤈ العدد الحقيقي الان  ↫ ( '..ok..' ) \n', 1, 'md')
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ *لاتوجد مجموعات وهميه*', 1, 'md')   
else
local Davidgp2 = (w + q)
...
Davidgp2 = '\n𖢅⤈ تم حذف ↫ { '..q..' } مجموعه من البوت'
end
if w == 0 then
Davidgp1 = ''
else
Davidgp1 = '\n𖢅⤈ تم حذف ↫ { '..w..' } مجموعه بسبب تنزيل البوت الى عضو'
end
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ عدد الجروبات الان ↫ { '..#group..' }'..Davidgp1..Davidgp2..'\n𖢅⤈ العدد الحقيقي الان  ↫ ( '..Davidgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تفعيل ميزة الحذف التلقائي للميديا'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
...
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تعطيل الحذف التلقائي للميديا'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ قم بتحديد عدد اكبر من 10 واصغر من 1000 للحذف التلقائي', 1, 'md')
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم وضع ↫ *'..Num..'* من الميديا للحذف التلقائي', 1, 'md')
...
SendText(msg.chat_id_,"𖢅⤈ تم حذف "..Del.." من الميديا تلقائيا",0,'md') 
...
if M ~= 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ عدد الميديا ↫ "..M.."\n𖢅⤈ الحذف التلقائي ↫ "..(DevRio:get(David..'Rio:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لاتوجد ميديا هنا", 1, 'md') 
end end
end
end
--     Source David     --
if text == "تفعيل امسح" and Constructor(msg) then
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تفعيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(David..'Rio:Lock:Clean'..msg.chat_id_,true)  
end
if text == "تعطيل امسح" and Constructor(msg) then
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تعطيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
...
if M ~= 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ عدد الميديا ↫ "..M, 1, 'md') 
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لاتوجد ميديا هنا", 1, 'md') 
end end
...
if Del ~= 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حذف "..Del.." من الميديا", 1, 'md') 
...
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تفعيل مسح الاغاني بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(David..'Rio:Lock:CleanMusic'..msg.chat_id_,true)  
end
if text == "تعطيل مسح الاغاني" and Constructor(msg) then
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تعطيل مسح الاغاني بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(David..'Rio:Lock:CleanMusic'..msg.chat_id_) 
end
if CleanerMusic(msg) then
if DevRio:get(David..'Rio:Lock:CleanMusic'..msg.chat_id_) then 
if text == "الاغاني" and ChCheck(msg) or text == "عدد الاغاني" and ChCheck(msg) then 
local M = DevRio:scard(David.."Rio:cleanermusic"..msg.chat_id_)
if M ~= 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ عدد الاغاني ↫ "..M, 1, 'md') 
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لاتوجد اغاني هنا", 1, 'md') 
end end
if text == "مسح الاغاني" or text == "تنظيف الاغاني" or text == "حذف الاغاني" then
local List = DevRio:smembers(David.."Rio:cleanermusic"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
if Del ~= 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حذف "..Del.." من الاغاني", 1, 'md') 
DevRio:del(David.."Rio:cleanermusic"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لاتوجد اغاني هنا", 1, 'md') 
end end end end
--     Source David     --
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم تنظيف 100 من الرسائل المعدله', 1, 'md')
end
--     Source David     --
if ChatType == 'sp' or ChatType == 'gp'  then
if Admin(msg) then
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح التعديل")  
DevRio:del(David..'Rio:Lock:EditMsgs'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ التعديل بالفعل مفتوح في المجموعه', 1, 'md')
end
end
if RioConstructor(msg) then
if UnLockText[2] == "التعديل الميديا" or UnLockText[2] == "تعديل الميديا" then
if DevRio:get(David..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح تعديل الميديا")  
DevRio:del(David..'Rio:Lock:EditMsgs'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تعديل الميديا بالفعل مفتوح في المجموعه', 1, 'md')
end
end
end
if UnLockText[2] == "الفارسيه" then
if DevRio:get(David..'Rio:Lock:Farsi'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الفارسيه")  
DevRio:del(David..'Rio:Lock:Farsi'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الفارسيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الفشار" then
if not DevRio:get(David..'Rio:Lock:Fshar'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الفشار")  
DevRio:set(David..'Rio:Lock:Fshar'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الفشار بالفعل مفتوح في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الطائفيه" then
if not DevRio:get(David..'Rio:Lock:Taf'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الطائفيه")  
DevRio:set(David..'Rio:Lock:Taf'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الطائفيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكفر" then
if not DevRio:get(David..'Rio:Lock:Kfr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الكفر")  
DevRio:set(David..'Rio:Lock:Kfr'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الكفر بالفعل مفتوح في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الفارسيه بالطرد" then
if DevRio:get(David..'Rio:Lock:FarsiBan'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الفارسيه بالطرد")  
DevRio:del(David..'Rio:Lock:FarsiBan'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الفارسيه بالطرد بالفعل مفتوحه', 1, 'md')
end
end
if RioConstructor(msg) then
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح البوتات")  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevRio:get(David..'Rio:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح التثبيت")  
DevRio:del(David..'Rio:Lock:Pin'..msg.chat_id_)
DevRio:srem(David.."Rio:Lock:Pinpin",msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ التثبيت بالفعل مفتوح في المجموعه', 1, 'md')
end end end
end
end
--     Source David     --
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الدردشه")  
DevRio:set(David..'Rio:Lock:Text'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الدردشه بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الاونلاين" then
if not DevRio:get(David..'Rio:Lock:Inline'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الاونلاين")  
DevRio:set(David..'Rio:Lock:Inline'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الاونلاين بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الصور" then
if not DevRio:get(David..'Rio:Lock:Photo'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الصور")  
DevRio:set(David..'Rio:Lock:Photo'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الصور بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الكلايش" then
if not DevRio:get(David..'Rio:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الكلايش")  
DevRio:set(David..'Rio:Lock:Spam'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الكلايش بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الدخول" then
if not DevRio:get(David..'Rio:Lock:Join'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الدخول")  
DevRio:set(David..'Rio:Lock:Join'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الدخول بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الفيديو" then
if not DevRio:get(David..'Rio:Lock:Videos'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الفيديو")  
DevRio:set(David..'Rio:Lock:Videos'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الفيديو بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "المتحركه" then
if not DevRio:get(David..'Rio:Lock:Gifs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل المتحركه")  
DevRio:set(David..'Rio:Lock:Gifs'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ المتحركه بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الاغاني" then
if not DevRio:get(David..'Rio:Lock:Music'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الاغاني")  
DevRio:set(David..'Rio:Lock:Music'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الاغاني بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الصوت" then
if not DevRio:get(David..'Rio:Lock:Voice'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الصوت")  
DevRio:set(David..'Rio:Lock:Voice'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الصوت بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الروابط" then
if not DevRio:get(David..'Rio:Lock:Links'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الروابط")  
DevRio:set(David..'Rio:Lock:Links'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الروابط بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "المواقع" then
if not DevRio:get(David..'Rio:Lock:Location'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل المواقع")  
DevRio:set(David..'Rio:Lock:Location'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ المواقع بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "المعرف" or LockText[2] == "المعرفات" then
if not DevRio:get(David..'Rio:Lock:Tags'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل المعرفات")  
DevRio:set(David..'Rio:Lock:Tags'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ المعرفات بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الملفات" then
if not DevRio:get(David..'Rio:Lock:Document'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الملفات")  
DevRio:set(David..'Rio:Lock:Document'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الملفات بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الهاشتاك" or LockText[2] == "التاك" then
if not DevRio:get(David..'Rio:Lock:Hashtak'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الهاشتاك")  
DevRio:set(David..'Rio:Lock:Hashtak'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الهاشتاك بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الجهات" then
if not DevRio:get(David..'Rio:Lock:Contact'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الجهات")  
DevRio:set(David..'Rio:Lock:Contact'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '️𖢅⤈ الجهات بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الشبكات" then
if not DevRio:get(David..'Rio:Lock:WebLinks'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الشبكات")  
DevRio:set(David..'Rio:Lock:WebLinks'..msg.chat_id_,true) 
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الشبكات بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "العربيه" then
if not DevRio:get(David..'Rio:Lock:Arabic'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل العربيه")  
DevRio:set(David..'Rio:Lock:Arabic'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ العربيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الانكليزيه" then
if not DevRio:get(David..'Rio:Lock:English'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الانكليزيه")  
DevRio:set(David..'Rio:Lock:English'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الانكليزيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الملصقات" then
if not DevRio:get(David..'Rio:Lock:Stickers'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الملصقات")  
DevRio:set(David..'Rio:Lock:Stickers'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الملصقات بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الماركداون" then
if not DevRio:get(David..'Rio:Lock:Markdown'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الماركداون")  
DevRio:set(David..'Rio:Lock:Markdown'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الماركداون بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الاشعارات" then
if not DevRio:get(David..'Rio:Lock:TagServr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل الاشعارات")  
DevRio:set(David..'Rio:Lock:TagServr'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الاشعارات بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "التوجيه" then
if not DevRio:get(David..'Rio:Lock:Forwards'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل التوجيه")  
DevRio:set(David..'Rio:Lock:Forwards'..msg.chat_id_,true)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ التوجيه بالفعل مقفل في المجموعه', 1, 'md')
end
end
end
end
...
if DevRio:get(David..'Rio:Lock:Text'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الدردشه")  
DevRio:del(David..'Rio:Lock:Text'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الدردشه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الصور" then
if DevRio:get(David..'Rio:Lock:Photo'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الصور")  
DevRio:del(David..'Rio:Lock:Photo'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevRio:get(David..'Rio:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الكلايش")  
DevRio:del(David..'Rio:Lock:Spam'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الكلايش بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الدخول" then
if DevRio:get(David..'Rio:Lock:Join'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الدخول")  
DevRio:del(David..'Rio:Lock:Join'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الدخول بالفعل مفتوح في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الفيديو" then
if DevRio:get(David..'Rio:Lock:Videos'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الفيديو")  
DevRio:del(David..'Rio:Lock:Videos'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الفيديو بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الملفات" then
if DevRio:get(David..'Rio:Lock:Document'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الملفات")  
DevRio:del(David..'Rio:Lock:Document'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الملفات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الاونلاين" then
if DevRio:get(David..'Rio:Lock:Inline'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الاونلاين")  
DevRio:del(David..'Rio:Lock:Inline'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الاونلاين بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الماركداون" then
if DevRio:get(David..'Rio:Lock:Markdown'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الماركداون")  
DevRio:del(David..'Rio:Lock:Markdown'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الماركداون بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "المتحركه" then
if DevRio:get(David..'Rio:Lock:Gifs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح المتحركه")  
DevRio:del(David..'Rio:Lock:Gifs'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ المتحركه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الاغاني" then
if DevRio:get(David..'Rio:Lock:Music'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الاغاني")  
DevRio:del(David..'Rio:Lock:Music'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الاغاني بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الصوت" then
if DevRio:get(David..'Rio:Lock:Voice'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الصوت")  
DevRio:del(David..'Rio:Lock:Voice'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الصوت بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الروابط" then
if DevRio:get(David..'Rio:Lock:Links'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الروابط")  
DevRio:del(David..'Rio:Lock:Links'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الروابط بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "المواقع" then
if DevRio:get(David..'Rio:Lock:Location'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح المواقع")  
DevRio:del(David..'Rio:Lock:Location'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ المواقع بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "المعرف" or UnLockText[2] == "المعرفات" then
if DevRio:get(David..'Rio:Lock:Tags'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح المعرفات")  
DevRio:del(David..'Rio:Lock:Tags'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ المعرفات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الهاشتاك" or UnLockText[2] == "التاك" then
if DevRio:get(David..'Rio:Lock:Hashtak'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الهاشتاك")  
DevRio:del(David..'Rio:Lock:Hashtak'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الهاشتاك بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الجهات" then
if DevRio:get(David..'Rio:Lock:Contact'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الجهات")  
DevRio:del(David..'Rio:Lock:Contact'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الجهات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الشبكات" then
if DevRio:get(David..'Rio:Lock:WebLinks'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الشبكات")  
DevRio:del(David..'Rio:Lock:WebLinks'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الشبكات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "العربيه" then
if DevRio:get(David..'Rio:Lock:Arabic'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح العربيه")  
DevRio:del(David..'Rio:Lock:Arabic'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ العربيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الانكليزيه" then
if DevRio:get(David..'Rio:Lock:English'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الانكليزيه")  
DevRio:del(David..'Rio:Lock:English'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الانكليزيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الاشعارات" then
if DevRio:get(David..'Rio:Lock:TagServr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الاشعارات")  
DevRio:del(David..'Rio:Lock:TagServr'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الاشعارات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الملصقات" then
if DevRio:get(David..'Rio:Lock:Stickers'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح الملصقات")  
DevRio:del(David..'Rio:Lock:Stickers'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ الملصقات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "التوجيه" then
if DevRio:get(David..'Rio:Lock:Forwards'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح التوجيه")  
DevRio:del(David..'Rio:Lock:Forwards'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ التوجيه بالفعل مفتوح في المجموعه', 1, 'md')
end
end
end
end
...
if not Constructor(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ للمنشئين فقط', 1, 'md')
else
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل التفليش")  
end
end
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح التفليش")  
end
end
--     Source David     --
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم قفل جميع الاوامر")  
end
end
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم فتح جميع الاوامر")  
end
end
--     Source David     --
if Admin(msg) then
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ اختر عدد اكبر من 40 حرف ', 1, 'md')
else
DevRio:set(David..'Rio:Spam:Text'..msg.chat_id_,SetSpam)
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم وضع عدد السبام ↫'..SetSpam, 1, 'md')
end
end
end
--     Source David     --
...
if #admins == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ *لاتوجد بوتات هنا*", 1, 'md')
return false end
if #admins == i then 
local a = '𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ *عدد البوتات هنا* ↫ '..n..'\n'
local f = '𖢅⤈ *عدد البوتات المرفوعه* ↫ '..t..'\n𖢅⤈ *ملاحضه علامة الـ*✯ *تعني ان البوت ادمن في هذه المجموعه*'
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ *عدد البوتات هنا* ↫ "..c.."\n𖢅⤈ *عدد البوتات المرفوعه* ↫ "..x.."\n𖢅⤈ *تم طرد* ↫ "..(c - x).." *من البوتات*", 1, 'md')
end 
end,nil)  
end 
--     Source David     --
...
DevRio:del(David..'Rio:RioSudo:')
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف المطورين الاساسيين")  
end
end
if RioSudo(msg) then
if txts[2] == 'الثانويين' or txtss[2] == 'الثانويين' or txts[2] == 'المطورين الثانويين' or txtss[2] == 'المطورين الثانويين' then
DevRio:del(David..'Rio:SecondSudo:')
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف المطورين الثانويين")  
end
end
if SecondSudo(msg) then 
if txts[2] == 'المطورين' or txtss[2] == 'المطورين' then
DevRio:del(David..'Rio:SudoBot:')
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف المطورين")  
end
if txts[2] == 'قائمه العام' or txtss[2] == 'قائمه العام' then
DevRio:del(David..'Rio:BanAll:')
DevRio:del(David..'Rio:MuteAll:')
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف قائمة العام")  
end
end
if SecondSudoGp(msg) then
if txts[2] == 'مطورين المجموعه' or txtss[2] == 'مطورين المجموعه' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف مطورين المجموعه")  
DevRio:del(David..'Rio:SudoBotGp:'..msg.chat_id_)
end
end
if RioSudoGp(msg) then
if txts[2] == 'ثانويين المجموعه' or txtss[2] == 'ثانويين المجموعه' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف ثانويين المجموعه")  
DevRio:del(David..'Rio:SecondSudoGp:'..msg.chat_id_)
end
end
if RioSudo(msg) then
if txts[2] == 'اساسيين المجموعه' or txtss[2] == 'اساسيين المجموعه' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف اساسيين المجموعه")  
DevRio:del(David..'Rio:RioSudoGp:'..msg.chat_id_)
end
end
if SudoBot(msg) then
if txts[2] == 'المالكين' or txtss[2] == 'المالكين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف الماالكين")  
DevRio:del(David..'Rio:Owner:'..msg.chat_id_)
end
end
if SudoBot(msg) then
if txts[2] == 'المالكين' or txtss[2] == 'المالكين' then
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف المنشئين الاساسيين")  
DevRio:del(David..'Rio:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف المنشئين")  
DevRio:del(David..'Rio:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف المدراء")  
DevRio:del(David..'Rio:Managers:'..msg.chat_id_)
end 
if txts[2] == 'المنظفين' or txtss[2] == 'المنظفين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف المنظفين")  
DevRio:del(David..'Rio:Cleaner:'..msg.chat_id_)
end end
if Manager(msg) then
if txts[2] == 'الادمنيه' or txtss[2] == 'الادمنيه' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف الادمنيه")  
DevRio:del(David..'Rio:Admins:'..msg.chat_id_)
end
end
if txts[2] == 'قوانين' or txtss[2] == 'قوانين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف القوانين")  
DevRio:del(David..'Rio:rules'..msg.chat_id_)
end
if txts[2] == 'المطايه' or txtss[2] == 'المطايه' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف المطايه")  
DevRio:del(David..'User:Donky:'..msg.chat_id_)
end
if txts[2] == 'الرابط' or txtss[2] == 'الرابط' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف رابط المجموعه")  
DevRio:del(David.."Rio:Groups:Links"..msg.chat_id_)
end
if txts[2] == 'المميزين' or txtss[2] == 'المميزين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف المميزين")  
DevRio:del(David..'Rio:VipMem:'..msg.chat_id_)
end
if txts[2] == 'المكتومين' or txtss[2] == 'المكتومين' then
DevRio:del(David..'Rio:Muted:'..msg.chat_id_)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف المكتومين")  
end
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف المقيدين")  
end
if txts[2] == 'قوائم المنع' or txtss[2] == 'قوائم المنع' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف قوائم المنع")  
...
DevRio:del(David.."Rio:FilterAnimation"..msg.chat_id_)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف قائمة منع المتحركات")  
end
if txts[2] == 'قائمه منع الصور' or txtss[2] == 'قائمه منع الصور' then     
DevRio:del(David.."Rio:FilterPhoto"..msg.chat_id_)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف قائمة منع الصور")  
end
if txts[2] == 'قائمه منع الملصقات' or txtss[2] == 'قائمه منع الملصقات' then     
DevRio:del(David.."Rio:FilterSteckr"..msg.chat_id_)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف قائمة منع الملصقات")  
end
end
end
--     Source David     --
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ للمنشئ الاساسي فقط', 1, 'md')
else
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حذف ↫ ❨ قائمة المنع • المحظورين • المكتومين • الادمنيه • المميزين • المطايه ❩ بنجاح \n ✓", 1, 'md')
end end
--     Source David     --
if text and text:match("^حذف جميع الرتب$") and ChCheck(msg) or text and text:match("^مسح جميع الرتب$") and ChCheck(msg) or text and text:match("^تنزيل جميع الرتب$") and ChCheck(msg) then
if not RioConstructor(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ للمالكين فقط', 1, 'md')
else
...
DevRio:del(David..'Rio:VipMem:'..msg.chat_id_)
DevRio:del(David..'User:Donky:'..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حذف جميع الرتب التاليه ↫ ❨ "..basicconstructort..constructort..Managerst..adminst..vipmemt..donkyt.." ❩ بنجاح \n ✓", 1, 'md')
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لاتوجد رتب هنا", 1, 'md')
end 
end 
end
--     Source David     --
...
--     Source David     --
local TXTE = "𖢅⤈ اعدادات المجموعه ↫ ⤈\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n"
.."𖢅⤈ الروابط ↫ "..mute_links.."\n"
.."𖢅⤈ المعرف ↫ "..lock_tag.."\n"
.."𖢅⤈ البوتات ↫ "..lock_bots.."\n"
.."𖢅⤈ المتحركه ↫ "..mute_gifs.."\n"
.."𖢅⤈ الملصقات ↫ "..lock_sticker.."\n"
.."𖢅⤈ الملفات ↫ "..lock_file.."\n"
.."𖢅⤈ الصور ↫ "..mute_photo.."\n"
.."𖢅⤈ الفيديو ↫ "..mute_video.."\n"
.."𖢅⤈ الاونلاين ↫ "..mute_in.."\n"
.."𖢅⤈ الدردشه ↫ "..mute_text.."\n"
.."𖢅⤈ التوجيه ↫ "..lock_forward.."\n"
.."𖢅⤈ الاغاني ↫ "..mute_music.."\n"
.."𖢅⤈ الصوت ↫ "..mute_voice.."\n"
.."𖢅⤈ الجهات ↫ "..lock_contact.."\n"
.."𖢅⤈ الماركداون ↫ "..markdown.."\n"
.."𖢅⤈ الهاشتاك ↫ "..lock_htag.."\n"
.."𖢅⤈ التعديل ↫ "..mute_edit.."\n"
.."𖢅⤈ التثبيت ↫ "..lock_pin.."\n"
.."𖢅⤈ الاشعارات ↫ "..lock_tgservice.."\n"
.."𖢅⤈ الكلايش ↫ "..lock_spam.."\n"
.."𖢅⤈ الدخول ↫ "..lock_Join.."\n"
.."𖢅⤈ الشبكات ↫ "..lock_wp.."\n"
.."𖢅⤈ المواقع ↫ "..lock_location.."\n"
.."𖢅⤈ الفشار ↫ "..lock_fshar.."\n"
.."𖢅⤈ الكفر ↫ "..lock_kaf.."\n"
.."𖢅⤈ الطائفيه ↫ "..lock_taf.."\n"
.."𖢅⤈ العربيه ↫ "..lock_arabic.."\n"
.."𖢅⤈ الانكليزيه ↫ "..lock_english.."\n"
.."𖢅⤈ الفارسيه ↫ "..lock_farsi.."\n"
.."𖢅⤈ التكرار ↫ "..flood.."\n"
.."𖢅⤈ عدد التكرار ↫ "..Flood_Num.."\n"
.."𖢅⤈ عدد السبام ↫ "..spam_c.."\n"
.."𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ [𝘾𝙃 𝘼𝙉𝙐𝘽𝙄𝙎 𓏶 ](https://t.me/SOURCEANUBIS)\n"
...
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevRio:del(David..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(David..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:set(David..'Rio:rules'..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم حفظ قوانين المجموعه', 1, 'md')
return false   
end
if text and text:match("^ضع قوانين$") and ChCheck(msg) or text and text:match("^وضع قوانين$") and ChCheck(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ ارسل لي القوانين الان', 1, 'md')
...
MyNumber = "𖢅⤈ رقمك ↫ +"..result.phone_number_
else
MyNumber = "𖢅⤈ رقمك موضوع لجهات اتصالك فقط"
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ ارسل لي الكلمه لزخرفتها \nيمكنك الزخرفة باللغه { en } ~ { ar } ', 1, 'md')
end
end
if not DevRio:get(David..'Rio:Zrf:Rio'..msg.chat_id_) then
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevRio:get(David..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء امر نسبة الحب ', 1, 'md')
DevRio:del(David..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ نسبة الحب بين '..text..' هي : '..Rio..'%', 1, 'md')
DevRio:del(David..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevRio:get(David..'Rio:Nsba:Rio'..msg.chat_id_) then
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
...
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء امر نسبة الخيانه ', 1, 'md')
DevRio:del(David..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ نسبة الخيانه بين '..text..' هي : '..Rio..'%', 1, 'md')
DevRio:del(David..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevRio:get(David..'Rio:Nsba:Rio'..msg.chat_id_) then
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
...
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء امر نسبة الجمال ', 1, 'md')
DevRio:del(David..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ نسبة جمال '..text..' هي : '..Rio..'%', 1, 'md')
DevRio:del(David..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevRio:get(David..'Rio:Nsba:Rio'..msg.chat_id_) then
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
...
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء امر نسبة الكره ', 1, 'md')
DevRio:del(David..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ نسبة الكره بين '..text..' هي : '..Rio..'%', 1, 'md')
DevRio:del(David..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevRio:get(David..'Rio:Nsba:Rio'..msg.chat_id_) then
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
...
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء امر نسبة الرجوله ', 1, 'md')
DevRio:del(David..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ نسبة رجولة '..text..' هي : '..Rio..'%', 1, 'md')
DevRio:del(David..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevRio:get(David..'Rio:Nsba:Rio'..msg.chat_id_) then
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
...
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم الغاء امر نسبة الانوثه ', 1, 'md')
DevRio:del(David..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ نسبة انوثة '..text..' هي : '..Rio..'%', 1, 'md')
DevRio:del(David..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevRio:get(David..'Rio:Nsba:Rio'..msg.chat_id_) then
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
...
if text and (text == "متحركه" or text == "↫ متحركه ᥀") and not DevRio:get(David..'Rio:gif:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,1075); 
local Text ='*𖢅⤈ تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/gif:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅 •',url="t.me/SOURCEANUBIS"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if text and (text == "ميمز" or text == "↫ ميمز ᥀") and not DevRio:get(David..'Rio:memz:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,1201); 
local Text ='*𖢅⤈ تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/memz:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅 •',url="t.me/SOURCEANUBIS"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*𖢅⤈ تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Song:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅 •',url="t.me/SOURCEANUBIS"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if text and (text == "اغنيه" or text == "↫ اغنيه ᥀" or text == "اغاني") and not DevRio:get(David..'Rio:mp3:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,1167); 
local Text ='*𖢅⤈ تم اختيار الاغنيه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅 •',url="t.me/SOURCEANUBIS"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if text and (text == "ريمكس" or text == "↫ ريمكس ᥀") and not DevRio:get(David..'Rio:Remix:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,612); 
local Text ='*𖢅⤈ تم اختيار الريمكس لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/remix:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅 •',url="t.me/SOURCEANUBIS"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if text and (text == "صوره" or text == "↫ صوره ᥀") and not DevRio:get(David..'Rio:Photo:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(4,1171); 
local Text ='*𖢅⤈ تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/photo:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅 •',url="t.me/SOURCEANUBIS"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*𖢅⤈ تم اختيار الفلم لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Movies:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅 •',url="t.me/SOURCEANUBIS"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تعطيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(David..'Rio:Series:Rio'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ᥀") and not DevRio:get(David..'Rio:Series:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,54); 
local Text ='*𖢅⤈ تم اختيار المسلسل لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/series:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅 •',url="t.me/SOURCEANUBIS"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"𖢅⤈ ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات")  
else
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تغير اسم المجموعه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,"𖢅⤈ عذرا البوت ليس ادمن يرجى ترقيتي والمحاوله لاحقا") 
...
Dev_Rio(msg.chat_id_,msg.id_, 1, '𖢅⤈ ارسل صورة المجموعه الان', 1, 'md')
DevRio:set(David..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source David     --
if text and text:match("^حذف الصوره$") and ChCheck(msg) or text and text:match("^مسح الصوره$") and ChCheck(msg) then
https.request("https://api.telegram.org/bot"..TokenBot.."/deleteChatPhoto?chat_id="..msg.chat_id_) 
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف صورة المجموعه")  
return false  
end
--     Source David     --
if Manager(msg) then
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم طرد المحذوفين")  
end,nil)
end
--     Source David     --
...
Dev_Rio(msg.chat_id_, msg.id_, 0,'𖢅⤈ *لا يوجد محظورين*', 1, 'md')
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف المحظورين")  
end
end
...
ConstructorRio = "["..Rio.first_name_.."](T.me/"..(Rio.username_ or "SOURCEANUBIS")..")"
else 
ConstructorRio = "حساب محذوف"
end
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ المجموعه ↫ ["..dp.title_.."]("..LinkGroup..")\n𖢅⤈ الايدي ↫ ( `"..ChatId.."` )\n𖢅⤈ المنشئ ↫ "..ConstructorRio.."\n𖢅⤈ عدد المدراء ↫ ( *"..ManagerList.."* )\n𖢅⤈ عدد المنشئين ↫ ( *"..ConstructorList.."* )\n𖢅⤈ عدد الادمنيه ↫ ( *"..AdminsList.."* )\n𖢅⤈ عدد المميزين ↫ ( *"..VipList.."* )\n𖢅⤈ عدد المحظورين ↫ ( *"..BanedList.."* )\n𖢅⤈ عدد المقيدين ↫ ( *"..TkeedList.."* )\n𖢅⤈ عدد المكتومين ↫ ( *"..MutedList.."* )", 1,"md")
end,nil)
end
end
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لم تتم اضافتي بها لاقوم بكشفها", 1, "md")
end
end,nil)
end,nil)
end 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم وضع عدد الاعضاء ↫ *'..Num..'* عضو', 1, 'md')
end
--     Source David     --
...
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تفعيل الالعاب المتطوره بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
...
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تعطيل الالعاب المتطوره بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
...
if Admin(msg) then
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تعطيل جلب رابط انلاين المجموعه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
...
if Admin(msg) then
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تفعيل جلب رابط انلاين المجموعه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
...
if not RioConstructor(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لمالك المجموعه او اعلى فقط ', 1, 'md')
else
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تفعيل حذف ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(David.."Rio:Lock:GpRd"..msg.chat_id_)
return false  
end
end
...
local DavidTeam = '𖢅⤈ اهلا عزيزي ↫ '..RioRank(msg)..' \n𖢅⤈ تم تعطيل حذف ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(David.."Rio:Lock:GpRd"..msg.chat_id_,true)
return false  
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ المجموعه بالتاكيد معطله', 1, 'md')
else
ReplyStatus(msg,result.id_,"ReplyBy","𖢅⤈ تم تعطيل المجموعه "..dp.title_)  
DevRio:srem(David.."Rio:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
DevRio:set(David.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
if not Sudo(msg) then
SendText(DevId,"𖢅⤈ تم تعطيل مجموعه جديده ↫ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ بواسطة ↫ "..Name.."\n𖢅⤈ اسم المجموعه ↫ ["..NameChat.."]\n𖢅⤈ ايدي المجموعه ↫ ⤈ \n❨ `"..msg.chat_id_.."` ❩\n𖢅⤈ رابط المجموعه ↫ ⤈\n❨ ["..LinkGroup.."] ❩\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ الوقت ↫ "..os.date("%I:%M%p").."\n𖢅⤈ التاريخ ↫ "..os.date("%Y/%m/%d").."",0,'md')
end
end
end,nil)
end,nil)
...
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
LinkGroup = "𖢅⤈ رابط المجموعه ↫ ⤈\n❨ ["..LinkGroup.."] ❩"
else
LinkGroup = '𖢅⤈ ليست لدي صلاحية الدعوه لهذه المجموعه !'
end
if not Sudo(msg) then
SendText(DevId,"𖢅⤈ هناك من بحاجه الى مساعده ↫ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ الشخص ↫ "..Name.."\n𖢅⤈ اسم المجموعه ↫ ["..NameChat.."]\n𖢅⤈ ايدي المجموعه ↫ ⤈ \n❨ `"..msg.chat_id_.."` ❩\n"..LinkGroup.."\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ الوقت ↫ "..os.date("%I:%M%p").."\n𖢅⤈ التاريخ ↫ "..os.date("%Y/%m/%d").."",0,'md')
end
end,nil)
end,nil)
end
...
local List = DevRio:smembers(David.."Rio:Groups")
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لا توجد مجموعات مفعله', 1, 'md')
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ جاري ارسال نسخه تحتوي على ↫ '..#List..' مجموعه', 1, 'md')
local Text = "𖢅⤈ Source David\n𖢅⤈ File Bot Groups\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n"
for k,v in pairs(List) do
...
Text = Text..k.." ↬ ⤈ \n𖢅⤈ Group ID ↬ "..v.."\n𖢅⤈ Group Link ↬ "..(Groupslink or "Not Found").."\n𖢅⤈ Group Managers ↬ "..GroupsManagers.."\n𖢅⤈ Group Admins ↬ "..GroupsAdmins.."\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n"
end
...
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم الغاء امر الاذاعه بنجاح", 1, 'md')
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم اذاعة "..RioText.." بنجاح \n𖢅⤈ ‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
DevRio:del(David.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
end
--     Source David     --
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم اذاعة "..RioText.." بالتثبيت \n𖢅⤈ ‏في ↫ ❨ "..#List.." ❩ مجموعه \n ✓", 1, 'md')
DevRio:del(David.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end
--     Source David     --
if text and (text == 'حذف رد من متعدد' or text == 'مسح رد من متعدد') and ChCheck(msg) then
if not Bot(msg) and DevRio:get(David..'Rio:Lock:Rd'..msg.chat_id_) then 
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ لاتستطيع حذف رد وذالك بسبب تعطيله', 1, 'md')
return false
end
if not Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ للمدير واعلى فقط ', 1, 'md')
else
local List = DevRio:smembers(David..'Rio:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end end
DevRio:set(David..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لايوجد رد متعدد لهذه الكلمه ↫ "..text ,  1, "md")
return false
end
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ قم بارسال الرد المتعدد الذي تريد حذفه من الكلمه ↫ "..text ,  1, "md")
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ حسنا ارسل الكلمه لحذفها" ,  1, "md")
return false
end
if text == 'اضف رد متعدد' and ChCheck(msg) then
if not Bot(msg) and DevRio:get(David..'Rio:Lock:Rd'..msg.chat_id_) then 
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ لاتستطيع اضافه رد وذالك بسبب تعطيله', 1, 'md')
return false
end
if not Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ للمدير واعلى فقط ', 1, 'md')
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ حسنا ارسل الكلمه الان" ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
...
if DevRio:sismember(David..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
local Rio = "𖢅⤈ لاتستطيع اضافة رد بالتاكيد مضاف في القائمه قم بحذفه اولا !"
keyboard = {} 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حفظ الامر ارسل الرد الاول\n𖢅⤈ للخروج ارسل ↫ ( الغاء )" ,  1, "md")
...
DevRio:set(David..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SetKt')
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ حسنا ارسل امر `كت تويت` الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetKt = DevRio:get(David..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SetKt == 'SetKt' then
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم الغاء الامر" ,  1, "md")
DevRio:del(David..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حفظ الامر ارسل السؤال الاول\n𖢅⤈ للخروج ارسل ↫ ( الغاء )" ,  1, "md")
DevRio:set(David..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SaveKt')
DevRio:set(David..'Rio:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(David..'Rio:Sudo:Kt'..msg.chat_id_,text)
return false
end end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeRed:"..msg.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelRed:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
...
if not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ للمطور الثانوي واعلى فقط ', 1, 'md')
return false
end
...
DevRio:set(David.."DelSudoRep",text)
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeAllRed:"..msg.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelAllRed:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
...
MsgRep = '𖢅⤈ قائمة الردود المتعدده ↫ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevRio:smembers(David..'Rio:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
MsgRep = '𖢅⤈ لا توجد ردود متعدده مضافه'
end
send(msg.chat_id_,msg.id_,MsgRep)
end
if text and (text == 'حذف الردود المتعدده' or text == 'مسح الردود المتعدده') and ChCheck(msg) then
if not Bot(msg) and DevRio:get(David..'Rio:Lock:GpRd'..msg.chat_id_) then 
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ لاتستطيع حذف ردود المتعدده وذالك بسبب تعطيله', 1, 'md')
return false
end
if not Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ للمدير او اعلى فقط ', 1, 'md')
else
local redod = DevRio:smembers(David..'Rio:Manager:GpRedod'..msg.chat_id_)
if #redod == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لا توجد ردود متعدده مضافه" ,  1, "md")
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف الردود المتعدده")  
return false
end
end
end
...
if #redod == 0 then
MsgRep = '*𖢅⤈ لا توجد ردود مضافه*'
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح ردود المدير •",callback_data="/DelGpRed:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
...
if not Bot(msg) and DevRio:get(David..'Rio:Lock:GpRd'..msg.chat_id_) then 
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ لاتستطيع حذف ردود المدير وذالك بسبب تعطيله', 1, 'md')
return false
end
if not Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ للمدير او اعلى فقط ', 1, 'md')
...
local redod = DevRio:smembers(David..'Rio:Manager:GpRed'..msg.chat_id_)
if #redod == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لا توجد ردود مضافه" ,  1, "md")
else
for k,v in pairs(redod) do
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف ردود المدير")  
return false
end
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح ردود المطور •",callback_data="/DelGpRedAll:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
Msg_id = msg.id_/2097152/0.5
...
if not Bot(msg) and DevRio:get(David..'Rio:Lock:GpRd'..msg.chat_id_) then 
Dev_Rio(msg.chat_id_, msg.id_, 1,'𖢅⤈ لاتستطيع حذف ردود المطور وذالك بسبب تعطيله', 1, 'md')
return false
end
if not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ للمطور الثانوي او اعلى فقط ', 1, 'md')
else
local redod = DevRio:smembers(David.."Rio:Sudo:AllRed")
if #redod == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ لا توجد ردود مضافه" ,  1, "md")
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𖢅⤈ تم حذف ردود المطور")  
return false
end
end 
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل لي اسم البوت الان" ,  1, "md") 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم استعادة الكلايش الاصليه" ,  1, "md") 
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل كليشة (الاوامر) الان " ,  1, "md")
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل كليشة (م1) الان " ,  1, "md")
...
if not Admin(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ هذا الامر يخص الرتب الاعلى فقط\n𖢅⤈ ارسل ↫ (م6) لعرض اوامر الاعضاء', 1, 'md')
else
local Help = DevRio:get(David..'Rio:Help1')
local Text = [[
𖢅⤈ اوامر حماية المجموعه ↫ ⤈
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل كليشة (م2) الان " ,  1, "md")
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل كليشة (م3) الان " ,  1, "md")
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل كليشة (م4) الان " ,  1, "md")
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل كليشة (م5) الان " ,  1, "md")
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل كليشة (م6) الان " ,  1, "md")
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelRioSudo:"..msg.sender_user_id_},{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_},{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif RioSudo(msg) then
keyboard.inline_keyboard = {{{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_},{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif SecondSudo(msg) then
...
keyboard.inline_keyboard = {{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif BasicConstructor(msg) then
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif Constructor(msg) then
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif Manager(msg) then
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
elseif Admin(msg) then
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• Ch Anubis •',url="t.me/SOURCEANUBIS"}}}
end
Msg_id = msg.id_/2097152/0.5
...
local Leave = DevRio:get(David..'Rio:Leave')
local Text = [[
*𖢅⤈ هل انت متأكد من طرد البوت ؟*
]] 
keyboard = {} 
...
local msg_id = msg.id_/2097152/0.5 
https.request('http://ccccxcc.ml/David/YtAnTak.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source David     --
if SecondSudo(msg) then
if text == "تحديث السورس" and ChCheck(msg) or text == "تحديث سورس" and ChCheck(msg) or text == "↫ تحديث السورس ᥀" and ChCheck(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ جاري تحديث سورس انوبيس', 1, 'md') 
os.execute('rm -rf David.lua.lua') 
os.execute('wget https://raw.githubusercontent.com/UUUsiriaa/AnTaK/master/David.lua') 
dofile('David.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم التحديث الى الاصدار الجديد', 1, 'md') 
end
if text == 'تحديث البوت' and ChCheck(msg) or text == '↫ تحديث ᥀' and ChCheck(msg) then  
dofile('David.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n        ( تم تحديث ملفات البوت )        \n\27[0;34;49m\n") 
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم تحديث ملفات البوت", 1, "md")
end
--     Source David     --
...
send(msg.chat_id_, msg.id_,'𖢅⤈ تم نقل ↫ '..#Groups..' مجموعه\n𖢅⤈ تم نقل ↫ '..#Users..' مشترك\n𖢅⤈ من التحديث القديم الى التحديث الجديد')
end
end
--     Source David     --
if text == 'الملفات' and ChCheck(msg) and SecondSudo(msg) then
Files = '\n𖢅⤈ الملفات المفعله في البوت ↫ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n'
i = 0
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
if i == 0 then
Files = '𖢅⤈ لا توجد ملفات في البوت'
end
...
if Get_info then
local TextS = "\n𖢅⤈ قائمة ملفات متجر سورس انوبيس\n𖢅⤈ الملفات المتوفره حاليا ↫ ⤈\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n"
local TextE = "𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ علامة ↫ (✔) تعني الملف مفعل\n𖢅⤈ علامة ↫ (✖️) تعني الملف معطل\n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"𖢅⤈ لا يوجد اتصال من الـapi") 
end
end
...
send(msg.chat_id_,msg.id_,"𖢅⤈ تم حذف جميع الملفات المفعله")
end
...
send(msg.chat_id_, msg.id_,"\n𖢅⤈ الملف ↫ *"..FileName.."*\n𖢅⤈ تم تعطيله وحذفه من البوت بنجاح") 
dofile('David.lua')  
else
send(msg.chat_id_, msg.id_,"𖢅⤈ لا يوجد ملف بهذا الاسم") 
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم حذف معلومات الترحيب', 1, 'md')   
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم تفعيل الترحيب عند اضافة البوت في المجموعه', 1, 'md')   
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم تعطيل الترحيب عند اضافة البوت في المجموعه', 1, 'md')   
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ ارسل لي نص الترحيب', 1, 'md') 
DevRio:del(David..'Rio:Text:BotWelcome')
DevRio:del(David..'Rio:Photo:BotWelcome')
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حفظ النص ارسل لي صورة الترحيب\n𖢅⤈ ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
...
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حفظ النص والغاء حفظ صورة الترحيب", 1, "md") 
DevRio:del(David.."Rio:Set:BotWelcome"..msg.sender_user_id_)    
return false
end 
if msg.content_.photo_ and msg.content_.photo_.sizes_[1] then   
DevRio:set(David.."Rio:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حفظ النص وصورة الترحيب", 1, 'md')   
DevRio:del(David.."Rio:Set:BotWelcome"..msg.sender_user_id_)   
end
return false
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ ارسل كليشة المطور الان ", 1, "md")
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "𖢅⤈ تم حذف كليشة المطور", 1, "md")
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ تم تغيير كليشة الاشتراك الاجباري', 1, 'md')
end
...
local text = '𖢅⤈ حسنا ارسل كليشة الاشتراك الجديده'  
Dev_Rio(msg.chat_id_, msg.id_, 1,text, 1, 'md') 
end
...
textt = "𖢅⤈ تم حذف كليشة الاشتراك الاجباري"
...
local chtext = DevRio:get(David.."Rio:ChText")
if chtext then
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ كليشة الاشتراك ↫ ⤈ \n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n['..chtext..']', 1, 'md')
else
if DevRio:get(David.."Rio:ChId") then
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevRio:get(David.."Rio:ChId"))
local GetInfo = JSON.decode(Check)
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '𖢅⤈ لم يتم تعيين قناة الاشتراك الاجباري \n𖢅⤈ ارسل ↫ تعيين قناة الاشتراك للتعيين ', 1, 'md')
end end end end
--     Source David     --
...
Text = [[
𖢅⤈ [قناة السورس](https://t.me/SOURCEANUBIS)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '᥀ قناة السورس',url="t.me/SOURCEANUBIS"}}}
local msg_id = msg.id_/2097152/0.5
...
Text = [[
𖢅⤈ [مبرمج السورس](https://t.me/U_U_U_Q)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '᥀ مبرمج السورس',url="t.me/U_U_U_Q"}}}
local msg_id = msg.id_/2097152/0.5
...
if DevRio:get(David..'Rio:Lock:EditMsgs'..msg.chat_id_) and not Text and not RioConstructor(result) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,dp) 
local rioname = '𖢅⤈ العضو ↫ ['..dp.first_name_..'](tg://user?id='..dp.id_..')'
local rioid = '𖢅⤈ ايديه ↫ `'..dp.id_..'`'
local riotext = '𖢅⤈ قام بالتعديل على '..Media
local riotxt = '𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n𖢅⤈ تعالو يامشرفين اكو مخرب'
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,rio) 
local admins = rio.members_  
text = '\n𖢅○━━━━ 𝒂𝒏𝒖𝒃𝒊𝒔 𖢅━━━━○𖢅\n'
for i=0 , #admins do 
...
--   This Is The 𝘾𝙃 𝘼𝙉𝙐𝘽𝙄𝙎 𓏶  @SOURCEANUBIS .   --
--                - David -                 --
