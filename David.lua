...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙[Source Channel](https://t.me/SOURCEANUBIS)
]] 
keyboard = {} 
if Sudo(data) then
...
Dev_Rio(data.chat_id_, data.id_, 1,'᥀︙لاتستطيع اضافه رد وذالك بسبب تعطيله', 1, 'md')
return false
end
if not Manager(data) then
Dev_Rio(data.chat_id_, data.id_, 1, '᥀︙للمدير واعلى فقط ', 1, 'md')
else
...
if text == "الغاء" then 
Dev_Rio(data.chat_id_, data.id_, 1, "᥀︙تم الغاء الامر" ,  1, "md")
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCEANUBIS')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
...
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'SOURCEANUBIS')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
local inline = {{{text="• ᥀ المطور . •",url="t.me/"..(dp.username_ or "SOURCEANUBIS")}},{{text="• ᥀ السورس . •",url="https://t.me/SOURCEANUBIS"},{text="• ᥀ لتنصيب بوت . •",url="https://t.me/lTllTT"}},{{text="• ᥀ اضفني في مجموعتك . •",url="t.me/"..dp.username_.."?startgroup=botstart"}}}
...
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..David..'.json', '᥀︙يحتوي الملف على ↫ ⤈\n مجموعه '..#List..' \n مشترك '..#Users..' ' ,dl_cb, nil)
...
Text = [[
Welcome To Source
᥀︙[TeAm David](https://t.me/SOURCEANUBIS)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '᥀ Source Channel',url="https://t.me/SOURCEANUBIS"}},{{text = '᥀ Developer',url="t.me/lTllTT"}},{{text= '᥀ Exp Source .',url="https://t.me/ExpDavid"}}}
local msg_id = msg.id_/2097152/0.5
...
Text = [[
᥀︙[قناة السورس](https://t.me/SOURCEANUBIS)
]]
keyboard = {} 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '᥀ مبرمج السورس',url="t.me/lTllTT"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/lTllTT&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source David     --
