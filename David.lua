...
if DataText and DataText:match('/zDRGd:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/zDRGd::'..tonumber(data.sender_user_id_)..'(.*)')
local Teext =[[
• اختر برجك عزيزي •📮،⍆
]]
keyboard = {} 
...
{
{text="• مسح رسائلي •",callback_data="/zDRGd:"..msg.sender_user_id_},{text = 'الالعاب🎮', callback_data="/add"},
},
}
